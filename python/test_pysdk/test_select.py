...
class TestInfinity:
    ...
    def test_select_day_of_month(self, suffix):
        ...
        res, extra_res = table_obj.output(["day_of_month(c1)", "day_of_month(c2)", "day_of_month(c3)"]).to_pl()
        print(res)
    ...
    def test_select_day_of_year(self, suffix):
        ...
        res, extra_res = table_obj.output(["day_of_year(c1)", "day_of_year(c2)", "day_of_year(c3)"]).to_pl()
        print(res)
        assert res['dayofyear(c1)'][0] == 267, "The value of day_of_year(c1) should be 23"
        assert res['dayofyear(c2)'][0] == 146, "The value of day_of_yearc2) should be 26"
        assert res['dayofyear(c3)'][0] == 267, "The value of day_of_year(c3) should be 23"
