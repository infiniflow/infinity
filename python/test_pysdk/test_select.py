...
class TestInfinity:
    ...
    def test_select_year(self, suffix):
        ...
        table_obj.insert(
            [{"c1": "2024-09-23", "c2":  "2022-05-26 21:44:33"}])

        res, extra_res = table_obj.output(["year(c1)", "year(c2)"]).to_pl()
        print(res)
    ...
    def test_select_month(self, suffix):
        ...
        res, extra_res = table_obj.output(["month(c1)", "month(c2)"]).to_pl()
        print(res)
    ...
    def test_select_day(self, suffix):
        ...
        res, extra_res = table_obj.output(["day(c1)", "day(c2)"]).to_pl()
        print(res)
