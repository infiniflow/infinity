...
def generate_dense(model: FlagModel, corpus: datasets.Dataset, max_passage_length: int, batch_size: int):
    dense_embeddings = model.encode_corpus(corpus["text"], batch_size=batch_size, max_length=max_passage_length)
