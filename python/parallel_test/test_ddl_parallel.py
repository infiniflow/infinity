...
vec_columns = [{"c1": "vector,1024,float", "c2" : "vector,512,int", "c3" : "int"}, {"c1" : "vector,512,float", "c2": "vector,1024,int", "c3" : "float"}]
fulltext_columns = [{"doctitle": "varchar", "docdate": "varchar", "body": "varchar"}, {"doctitle": "varchar", "docdate": "varchar", "body": "int"}]
    ...
    if (len(exist_tables) > 0):
        ...
        try:
            ...
            if(table_name[0:3] == "vec"):
                ...
                index_option = []
            table_obj.create_index(index_on, [index.IndexInfo(index_on, index_type, index_option)], conflict_type=ConflictType.Ignore)
