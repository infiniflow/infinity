...
class ListDatabaseResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i255 in range(_size251):
                        _elem256 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.db_dirs.append(_elem256)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i261 in range(_size257):
                        ...
                        self.db_comments.append(_elem262)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.db_comments is not None:
            ...
            for iter265 in self.db_comments:
...
class ListTableResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i270 in range(_size266):
                        ...
                        self.table_names.append(_elem271)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.table_names is not None:
            ...
            for iter272 in self.table_names:
...
class ListIndexResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i277 in range(_size273):
                        ...
                        self.index_names.append(_elem278)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.index_names is not None:
            ...
            for iter279 in self.index_names:
...
class IndexInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i284 in range(_size280):
                        _elem285 = InitParameter()
                        _elem285.read(iprot)
                        self.index_param_list.append(_elem285)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.index_param_list is not None:
            ...
            for iter286 in self.index_param_list:
                iter286.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class CreateTableRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            ...
            for iter293 in self.column_defs:
                iter293.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
...
class InsertRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i298 in range(_size294):
                        ...
                        self.column_names.append(_elem299)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.column_names is not None:
            ...
            for iter306 in self.column_names:
...
class ExplainRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i319 in range(_size315):
                        _elem320 = ParsedExpr()
                        _elem320.read(iprot)
                        self.select_list.append(_elem320)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i325 in range(_size321):
                        _elem326 = ParsedExpr()
                        _elem326.read(iprot)
                        self.highlight_list.append(_elem326)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i331 in range(_size327):
                        _elem332 = ParsedExpr()
                        _elem332.read(iprot)
                        self.group_by_list.append(_elem332)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i337 in range(_size333):
                        _elem338 = OrderByExpr()
                        _elem338.read(iprot)
                        self.order_by_list.append(_elem338)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
    ...
    def write(self, oprot):
        ...
        if self.select_list is not None:
            ...
            for iter339 in self.select_list:
                iter339.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.highlight_list is not None:
            ...
            for iter340 in self.highlight_list:
                iter340.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.search_expr is not None:
        ...
        if self.group_by_list is not None:
            ...
            for iter341 in self.group_by_list:
                iter341.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.order_by_list is not None:
            ...
            for iter342 in self.order_by_list:
                iter342.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class ExplainResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i347 in range(_size343):
                        _elem348 = ColumnDef()
                        _elem348.read(iprot)
                        self.column_defs.append(_elem348)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i353 in range(_size349):
                        _elem354 = ColumnField()
                        _elem354.read(iprot)
                        self.column_fields.append(_elem354)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            oprot.writeFieldBegin('column_defs', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.column_defs))
            for iter355 in self.column_defs:
                iter355.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_fields is not None:
            ...
            for iter356 in self.column_fields:
                iter356.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class SelectRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i361 in range(_size357):
                        _elem362 = ParsedExpr()
                        _elem362.read(iprot)
                        self.select_list.append(_elem362)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i367 in range(_size363):
                        _elem368 = ParsedExpr()
                        _elem368.read(iprot)
                        self.highlight_list.append(_elem368)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i373 in range(_size369):
                        _elem374 = ParsedExpr()
                        _elem374.read(iprot)
                        self.group_by_list.append(_elem374)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i379 in range(_size375):
                        _elem380 = OrderByExpr()
                        _elem380.read(iprot)
                        self.order_by_list.append(_elem380)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.select_list is not None:
            oprot.writeFieldBegin('select_list', TType.LIST, 4)
            oprot.writeListBegin(TType.STRUCT, len(self.select_list))
            for iter381 in self.select_list:
                iter381.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.highlight_list is not None:
            oprot.writeFieldBegin('highlight_list', TType.LIST, 5)
            oprot.writeListBegin(TType.STRUCT, len(self.highlight_list))
            for iter382 in self.highlight_list:
                iter382.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.search_expr is not None:
        ...
        if self.group_by_list is not None:
            oprot.writeFieldBegin('group_by_list', TType.LIST, 8)
            oprot.writeListBegin(TType.STRUCT, len(self.group_by_list))
            for iter383 in self.group_by_list:
                iter383.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.having_expr is not None:
...
class SelectResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i389 in range(_size385):
                        _elem390 = ColumnDef()
                        _elem390.read(iprot)
                        self.column_defs.append(_elem390)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i395 in range(_size391):
                        _elem396 = ColumnField()
                        _elem396.read(iprot)
                        self.column_fields.append(_elem396)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            oprot.writeFieldBegin('column_defs', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.column_defs))
            for iter397 in self.column_defs:
                iter397.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_fields is not None:
...
class UpdateRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i403 in range(_size399):
                        _elem404 = UpdateExpr()
                        _elem404.read(iprot)
                        self.update_expr_array.append(_elem404)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.update_expr_array is not None:
            ...
            for iter405 in self.update_expr_array:
                iter405.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
...
class AddColumnsRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i410 in range(_size406):
                        _elem411 = ColumnDef()
                        _elem411.read(iprot)
                        self.column_defs.append(_elem411)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            oprot.writeFieldBegin('column_defs', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.column_defs))
            for iter412 in self.column_defs:
                iter412.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
...
class DropColumnsRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i417 in range(_size413):
                        ...
                        self.column_names.append(_elem418)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.column_names is not None:
            oprot.writeFieldBegin('column_names', TType.LIST, 3)
            oprot.writeListBegin(TType.STRING, len(self.column_names))
            for iter419 in self.column_names:
