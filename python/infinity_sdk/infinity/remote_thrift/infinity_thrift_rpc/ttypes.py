...
class AlterIndexOptions(object):
    """
    Attributes:
     - index_name
     - opt_params
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('AlterIndexOptions')
...
class AlterIndexRequest(object):
    """
    Attributes:
     - db_name
     - table_name
    ...
    def __init__(self, db_name = None, table_name = None, alter_index_options = None, session_id = None,):
        self.db_name = db_name
        self.table_name = table_name
        self.alter_index_options = alter_index_options
        self.session_id = session_id
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.alter_index_options = AlterIndexOptions()
                    self.alter_index_options.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I64:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('AlterIndexRequest')
        if self.db_name is not None:
            oprot.writeFieldBegin('db_name', TType.STRING, 1)
            oprot.writeString(self.db_name.encode('utf-8') if sys.version_info[0] == 2 else self.db_name)
            oprot.writeFieldEnd()
        if self.table_name is not None:
            ...
            oprot.writeString(self.table_name.encode('utf-8') if sys.version_info[0] == 2 else self.table_name)
            oprot.writeFieldEnd()
        if self.alter_index_options is not None:
            oprot.writeFieldBegin('alter_index_options', TType.STRUCT, 3)
            self.alter_index_options.write(oprot)
            oprot.writeFieldEnd()
        if self.session_id is not None:
            oprot.writeFieldBegin('session_id', TType.I64, 4)
            oprot.writeI64(self.session_id)
...
class RenameTableRequest(object):
    """
    Attributes:
     - db_name
     - table_name
    ...
    def __init__(self, db_name = None, table_name = None, new_table_name = None, session_id = None,):
        self.db_name = db_name
        self.table_name = table_name
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.new_table_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I64:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('RenameTableRequest')
        if self.db_name is not None:
            oprot.writeFieldBegin('db_name', TType.STRING, 1)
            oprot.writeString(self.db_name.encode('utf-8') if sys.version_info[0] == 2 else self.db_name)
            oprot.writeFieldEnd()
        ...
        if self.new_table_name is not None:
            oprot.writeFieldBegin('new_table_name', TType.STRING, 3)
            oprot.writeString(self.new_table_name.encode('utf-8') if sys.version_info[0] == 2 else self.new_table_name)
            oprot.writeFieldEnd()
        if self.session_id is not None:
            oprot.writeFieldBegin('session_id', TType.I64, 4)
            oprot.writeI64(self.session_id)
...
all_structs.append(AlterIndexOptions)
AlterIndexOptions.thrift_spec = (
    None,  # 0
...
all_structs.append(AlterIndexRequest)
AlterIndexRequest.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'db_name', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'table_name', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'alter_index_options', [AlterIndexOptions, None], None, ),  # 3
    (4, TType.I64, 'session_id', None, None, ),  # 4
)
...
all_structs.append(RenameTableRequest)
RenameTableRequest.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'db_name', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'table_name', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'new_table_name', 'UTF8', None, ),  # 3
    (4, TType.I64, 'session_id', None, None, ),  # 4
)
