...
class ColumnDef(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i214 in range(_size210):
                        ...
                        self.constraints.append(_elem215)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.constraints is not None:
            ...
            for iter216 in self.constraints:
...
class Field(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i221 in range(_size217):
                        _elem222 = ParsedExpr()
                        _elem222.read(iprot)
                        self.parse_exprs.append(_elem222)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parse_exprs is not None:
            ...
            for iter223 in self.parse_exprs:
                iter223.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class ColumnField(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i228 in range(_size224):
                        ...
                        self.column_vectors.append(_elem229)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.column_vectors is not None:
            ...
            for iter230 in self.column_vectors:
...
class OptimizeOptions(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i235 in range(_size231):
                        ...
                        _elem236.read(iprot)
                        self.opt_params.append(_elem236)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.opt_params is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.opt_params))
            for iter237 in self.opt_params:
                iter237.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class ListTableResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i249 in range(_size245):
                        ...
                        self.table_names.append(_elem250)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.table_names is not None:
            ...
            for iter251 in self.table_names:
...
class ListIndexResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i256 in range(_size252):
                        ...
                        self.index_names.append(_elem257)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.index_names is not None:
            ...
            for iter258 in self.index_names:
...
class IndexInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i263 in range(_size259):
                        ...
                        _elem264.read(iprot)
                        self.index_param_list.append(_elem264)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.index_param_list is not None:
            ...
            for iter265 in self.index_param_list:
                iter265.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class CreateTableRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            ...
            for iter272 in self.column_defs:
                iter272.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
...
class InsertRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i277 in range(_size273):
                        ...
                        self.column_names.append(_elem278)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.column_names is not None:
            ...
            for iter285 in self.column_names:
...
class SelectRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i339 in range(_size335):
                        _elem340 = ParsedExpr()
                        _elem340.read(iprot)
                        self.group_by_list.append(_elem340)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i345 in range(_size341):
                        _elem346 = OrderByExpr()
                        _elem346.read(iprot)
                        self.order_by_list.append(_elem346)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.select_list is not None:
            oprot.writeFieldBegin('select_list', TType.LIST, 4)
            oprot.writeListBegin(TType.STRUCT, len(self.select_list))
            for iter347 in self.select_list:
                iter347.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.search_expr is not None:
...
class UpdateRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i368 in range(_size364):
                        _elem369 = UpdateExpr()
                        _elem369.read(iprot)
                        self.update_expr_array.append(_elem369)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.update_expr_array is not None:
            ...
            for iter370 in self.update_expr_array:
                iter370.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
