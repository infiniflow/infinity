...
class ThriftInfinityClient:
    ...
    def _reconnect(self):
        ...
        # version: 0.6.0.dev7 and 0.6.0 and 0.6.1 and 0.6.2 and 0.6.3 and 0.6.4 and 0.6.5 and 0.6.6, client_version: 32
        res = self.client.Connect(ConnectRequest(client_version=32))  # 0.6.6
        if res.error_code != 0:
