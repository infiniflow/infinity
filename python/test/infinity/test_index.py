...
class TestInfinity:
    ...
    def setup(self, local_infinity):
        ...
        self.test_infinity_obj = TestIndex(self.uri, connect=False)
    ...
    def test_create_index_IVFFlat(self, get_infinity_db):
        self.test_infinity_obj._test_create_index_IVFFlat(get_infinity_db)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_create_index_HNSW(self, get_infinity_db):
        self.test_infinity_obj._test_create_index_HNSW(get_infinity_db)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_create_index_fulltext(self, get_infinity_db):
        self.test_infinity_obj._test_create_index_fulltext(get_infinity_db)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_drop_non_existent_index(self, get_infinity_db):
        self.test_infinity_obj._test_drop_non_existent_index(get_infinity_db)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_create_created_index(self, get_infinity_db):
        self.test_infinity_obj._test_create_created_index(get_infinity_db)
    ...
    def test_create_drop_vector_index_invalid_options(self, get_infinity_db, column_name, index_type, params, types):
        self.test_infinity_obj._test_create_drop_vector_index_invalid_options(get_infinity_db, column_name, index_type,
                                                                         params, types)
    ...
    def test_create_drop_different_fulltext_index_invalid_options(self, get_infinity_db, column_name, index_type,
                                                                  params, types):
        self.test_infinity_obj._test_create_drop_different_fulltext_index_invalid_options(get_infinity_db, column_name,
                                                                                     index_type,
                                                                                     params, types)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_create_index_on_dropped_table(self, get_infinity_db):
        self.test_infinity_obj._test_create_index_on_dropped_table(get_infinity_db)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_create_index_show_index(self, get_infinity_db):
        self.test_infinity_obj._test_create_index_show_index(get_infinity_db)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_drop_index_show_index(self, get_infinity_db):
        self.test_infinity_obj._test_drop_index_show_index(get_infinity_db)
    ...
    def test_create_index_on_different_type_of_column(self, get_infinity_db, types, index_type):
        self.test_infinity_obj._test_create_index_on_different_type_of_column(get_infinity_db, types, index_type)
    ...
    def test_insert_data_create_index(self, get_infinity_db, index_type):
        self.test_infinity_obj._test_insert_data_create_index(get_infinity_db, index_type)
    ...
    def test_import_data_create_index(self, get_infinity_db, index_type, file_format):
        self.test_infinity_obj._test_import_data_create_index(get_infinity_db, index_type, file_format)
    ...
    def test_create_vector_index_import_data(self, get_infinity_db, index_type, file_format):
        self.test_infinity_obj._test_create_vector_index_import_data(get_infinity_db, index_type, file_format)
    ...
    def test_create_index_import_data(self, get_infinity_db, index_type, file_format):
        self.test_infinity_obj._test_create_index_import_data(get_infinity_db, index_type, file_format)

    @pytest.mark.parametrize("file_format", ["csv"])
    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_insert_data_fulltext_index_search(self, get_infinity_db, file_format):
        self.test_infinity_obj._test_insert_data_fulltext_index_search(get_infinity_db, file_format)
    ...
    def test_fulltext_match_with_invalid_analyzer(self, get_infinity_db, check_data):
        self.test_infinity_obj._test_fulltext_match_with_invalid_analyzer(get_infinity_db, check_data)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_create_index_on_deleted_table(self, get_infinity_db):
        self.test_infinity_obj._test_create_index_on_deleted_table(get_infinity_db)
    ...
    def test_create_index_on_update_table(self, get_infinity_db):
        self.test_infinity_obj._test_create_index_on_update_table(get_infinity_db)
    ...
    def test_create_index_with_valid_options(self, get_infinity_db, conflict_type):
        self.test_infinity_obj._test_create_index_with_valid_options(get_infinity_db, conflict_type)
    ...
    def test_create_index_with_invalid_options(self, get_infinity_db, conflict_type):
        self.test_infinity_obj._test_create_index_with_invalid_options(get_infinity_db, conflict_type)

    @pytest.mark.parametrize("conflict_type", [ConflictType.Ignore,
                                               0])
    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_create_duplicated_index_with_valid_options(self, get_infinity_db, conflict_type):
        self.test_infinity_obj._test_create_duplicated_index_with_valid_options(get_infinity_db, conflict_type)
    ...
    def test_create_duplicated_index_with_valid_error_options(self, get_infinity_db, conflict_type):
        self.test_infinity_obj._test_create_duplicated_index_with_valid_error_options(get_infinity_db, conflict_type)
    ...
    def test_create_duplicated_index_with_invalid_options(self, get_infinity_db, conflict_type):
        self.test_infinity_obj._test_create_duplicated_index_with_invalid_options(get_infinity_db, conflict_type)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_show_index(self, get_infinity_db):
        self.test_infinity_obj._test_show_index(get_infinity_db)

    @pytest.mark.parametrize("index_name", ["my_index"])
    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_show_valid_name_index(self, get_infinity_db, index_name):
        self.test_infinity_obj._test_show_valid_name_index(get_infinity_db, index_name)
    ...
    def test_show_invalid_name_index(self, get_infinity_db, index_name):
        self.test_infinity_obj._test_show_invalid_name_index(get_infinity_db, index_name)

    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_list_index(self, get_infinity_db):
        self.test_infinity_obj._test_list_index(get_infinity_db)
    ...
    def test_drop_index_with_valid_options(self, get_infinity_db, conflict_type):
        self.test_infinity_obj._test_drop_index_with_valid_options(get_infinity_db, conflict_type)
    ...
    def test_drop_index_with_invalid_options(self, get_infinity_db, conflict_type):
        self.test_infinity_obj._test_drop_index_with_invalid_options(get_infinity_db, conflict_type)

    @pytest.mark.parametrize("index_distance_type",
                             ["l2", "ip"])
    @pytest.mark.parametrize("get_infinity_db", [""], indirect=True)
    def test_supported_vector_index(self, get_infinity_db, index_distance_type):
        self.test_infinity_obj._test_supported_vector_index(get_infinity_db, index_distance_type)
    ...
    def test_unsupported_vector_index(self, get_infinity_db, index_distance_type):
        self.test_infinity_obj._test_unsupported_vector_index(get_infinity_db, index_distance_type)
