...
class TestCase(TestSdk):
    ...
    def test_connection(self):
        ...
        local_infinity_obj = infinity.connect(uri=None, path=common_values.TEST_LOCAL_PATH)
    ...
    def test_local_basic(self, check_data):
        infinity_obj = infinity.connect(uri=None, path=common_values.TEST_LOCAL_PATH)
        assert infinity_obj
