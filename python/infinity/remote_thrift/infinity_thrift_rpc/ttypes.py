...
class KnnExpr(object):
    ...
    def __init__(self, column_expr=None, embedding_data=None, dimension=None, distance_type=None, embedding_data_type=None, topn=None,):
        self.column_expr = column_expr
    ...
    def write(self, oprot):
        ...
        if self.topn is not None:
            oprot.writeFieldBegin('topn', TType.I64, 6)
...
class SearchExpr(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i67 in range(_size63):
                        _elem68 = MatchExpr()
                        _elem68.read(iprot)
                        self.match_exprs.append(_elem68)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.match_exprs is not None:
            ...
            for iter75 in self.match_exprs:
                iter75.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class ConstantExpr(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i81 in range(_size77):
                        ...
                        self.i64_array_value.append(_elem82)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i87 in range(_size83):
                        ...
                        self.f64_array_value.append(_elem88)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.i64_array_value is not None:
            ...
            oprot.writeListBegin(TType.I64, len(self.i64_array_value))
            for iter89 in self.i64_array_value:
        ...
        if self.f64_array_value is not None:
            oprot.writeFieldBegin('f64_array_value', TType.LIST, 7)
            oprot.writeListBegin(TType.DOUBLE, len(self.f64_array_value))
            for iter90 in self.f64_array_value:
...
class Field(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i102 in range(_size98):
                        _elem103 = ParsedExpr()
                        _elem103.read(iprot)
                        self.parse_exprs.append(_elem103)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parse_exprs is not None:
            ...
            for iter104 in self.parse_exprs:
                iter104.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class ColumnField(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i109 in range(_size105):
                        ...
                        self.column_vectors.append(_elem110)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.column_vectors is not None:
            ...
            for iter111 in self.column_vectors:
                oprot.writeBinary(iter111)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_name is not None:
...
class ListTableResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i123 in range(_size119):
                        ...
                        self.table_names.append(_elem124)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.table_names is not None:
            ...
            for iter125 in self.table_names:
...
class IndexInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i130 in range(_size126):
                        ...
                        _elem131.read(iprot)
                        self.index_param_list.append(_elem131)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.index_param_list is not None:
            ...
            for iter132 in self.index_param_list:
                iter132.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class CreateIndexRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i137 in range(_size133):
                        _elem138 = IndexInfo()
                        _elem138.read(iprot)
                        self.index_info_list.append(_elem138)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.index_info_list is not None:
            ...
            for iter139 in self.index_info_list:
                iter139.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
...
class CreateTableRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i144 in range(_size140):
                        _elem145 = ColumnDef()
                        _elem145.read(iprot)
                        self.column_defs.append(_elem145)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            ...
            for iter146 in self.column_defs:
                iter146.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
...
class InsertRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i151 in range(_size147):
                        ...
                        self.column_names.append(_elem152)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.column_names is not None:
            ...
            for iter159 in self.column_names:
...
class SelectRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i165 in range(_size161):
                        _elem166 = ParsedExpr()
                        _elem166.read(iprot)
                        self.select_list.append(_elem166)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i171 in range(_size167):
                        _elem172 = ParsedExpr()
                        _elem172.read(iprot)
                        self.group_by_list.append(_elem172)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i177 in range(_size173):
                        _elem178 = OrderByExpr()
                        _elem178.read(iprot)
                        self.order_by_list.append(_elem178)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.select_list is not None:
            ...
            for iter179 in self.select_list:
                iter179.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.search_expr is not None:
        ...
        if self.group_by_list is not None:
            ...
            for iter180 in self.group_by_list:
                iter180.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.order_by_list is not None:
            ...
            for iter181 in self.order_by_list:
                iter181.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class SelectResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i186 in range(_size182):
                        _elem187 = ColumnDef()
                        _elem187.read(iprot)
                        self.column_defs.append(_elem187)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i192 in range(_size188):
                        _elem193 = ColumnField()
                        _elem193.read(iprot)
                        self.column_fields.append(_elem193)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            oprot.writeFieldBegin('column_defs', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.column_defs))
            for iter194 in self.column_defs:
                iter194.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_fields is not None:
            ...
            for iter195 in self.column_fields:
                iter195.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class UpdateRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i200 in range(_size196):
                        _elem201 = UpdateExpr()
                        _elem201.read(iprot)
                        self.update_expr_array.append(_elem201)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.update_expr_array is not None:
            ...
            for iter202 in self.update_expr_array:
                iter202.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
