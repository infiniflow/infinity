...
class SelectRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.select_list is not None:
            ...
            for iter165 in self.select_list:
                iter165.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.group_by_list is not None:
            ...
            for iter166 in self.group_by_list:
                iter166.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.order_by_list is not None:
            ...
            for iter167 in self.order_by_list:
                iter167.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class SelectResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i172 in range(_size168):
                        _elem173 = ColumnDef()
                        _elem173.read(iprot)
                        self.column_defs.append(_elem173)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i178 in range(_size174):
                        _elem179 = ColumnField()
                        _elem179.read(iprot)
                        self.column_fields.append(_elem179)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            oprot.writeFieldBegin('column_defs', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.column_defs))
            for iter180 in self.column_defs:
                iter180.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_fields is not None:
            ...
            for iter181 in self.column_fields:
                iter181.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class UpdateRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i186 in range(_size182):
                        _elem187 = UpdateExpr()
                        _elem187.read(iprot)
                        self.update_expr_array.append(_elem187)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.update_expr_array is not None:
            ...
            for iter188 in self.update_expr_array:
                iter188.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
