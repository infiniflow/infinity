...
class InitParameter(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.para_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.para_value = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.para_name is not None:
            oprot.writeFieldBegin('para_name', TType.STRING, 1)
            oprot.writeString(self.para_name.encode('utf-8') if sys.version_info[0] == 2 else self.para_name)
            oprot.writeFieldEnd()
        if self.para_value is not None:
            oprot.writeFieldBegin('para_value', TType.STRING, 2)
            oprot.writeString(self.para_value.encode('utf-8') if sys.version_info[0] == 2 else self.para_value)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class CreateIndexRequest(object):
    ...
    def __init__(self, db_name=None, table_name=None, index_name=None, column_names=[
    ], method_type=None, index_para_list=[
        ...
        if index_para_list is self.thrift_spec[6][4]:
            index_para_list = [
            ]
        self.index_para_list = index_para_list
        self.session_id = session_id
        self.option = option
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i67 in range(_size63):
                        ...
                        self.column_names.append(_elem68)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                    self.method_type = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    self.index_para_list = []
                    (_etype72, _size69) = iprot.readListBegin()
                    for _i73 in range(_size69):
                        _elem74 = InitParameter()
                        _elem74.read(iprot)
                        self.index_para_list.append(_elem74)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
    ...
    def write(self, oprot):
        ...
        if self.column_names is not None:
            ...
            for iter75 in self.column_names:
                oprot.writeString(iter75.encode('utf-8') if sys.version_info[0] == 2 else iter75)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.method_type is not None:
            oprot.writeFieldBegin('method_type', TType.STRING, 5)
            oprot.writeString(self.method_type.encode('utf-8') if sys.version_info[0] == 2 else self.method_type)
            oprot.writeFieldEnd()
        if self.index_para_list is not None:
            oprot.writeFieldBegin('index_para_list', TType.LIST, 6)
            oprot.writeListBegin(TType.STRUCT, len(self.index_para_list))
            for iter76 in self.index_para_list:
                iter76.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
        ...
        if self.option is not None:
            oprot.writeFieldBegin('option', TType.STRUCT, 8)
...
InitParameter.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'para_name', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'para_value', 'UTF8', None, ),  # 2
)
...
CreateIndexRequest.thrift_spec = (
    ...
    (5, TType.STRING, 'method_type', 'UTF8', None, ),  # 5
    (6, TType.LIST, 'index_para_list', (TType.STRUCT, [InitParameter, None], False), [
    ], ),  # 6
    (7, TType.I64, 'session_id', None, None, ),  # 7
    (8, TType.STRUCT, 'option', [Option, None], None, ),  # 8
)
