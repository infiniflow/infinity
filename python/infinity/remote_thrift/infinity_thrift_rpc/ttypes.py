            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i81 in range(_size77):
                        _elem82 = InitParameter()
                        _elem82.read(iprot)
                        self.opt_params.append(_elem82)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class SearchExpr(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i88 in range(_size84):
                        _elem89 = MatchExpr()
                        _elem89.read(iprot)
                        self.match_exprs.append(_elem89)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i100 in range(_size96):
                        _elem101 = MatchTensorExpr()
                        _elem101.read(iprot)
                        self.match_tensor_exprs.append(_elem101)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i106 in range(_size102):
                        _elem107 = FusionExpr()
                        _elem107.read(iprot)
                        self.fusion_exprs.append(_elem107)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.match_exprs is not None:
            ...
            for iter108 in self.match_exprs:
                iter108.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.match_tensor_exprs is not None:
            ...
            for iter110 in self.match_tensor_exprs:
                iter110.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.fusion_exprs is not None:
            ...
            for iter111 in self.fusion_exprs:
                iter111.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i116 in range(_size112):
                        _elem117 = ParsedExpr()
                        _elem117.read(iprot)
                        self.arguments.append(_elem117)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class ColumnDef(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i123 in range(_size119):
                        ...
                        self.constraints.append(_elem124)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.constraints is not None:
            ...
            for iter125 in self.constraints:
...
class Field(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i130 in range(_size126):
                        _elem131 = ParsedExpr()
                        _elem131.read(iprot)
                        self.parse_exprs.append(_elem131)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parse_exprs is not None:
            ...
            for iter132 in self.parse_exprs:
                iter132.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class ColumnField(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i137 in range(_size133):
                        ...
                        self.column_vectors.append(_elem138)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.column_vectors is not None:
            ...
            for iter139 in self.column_vectors:
                oprot.writeBinary(iter139)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_name is not None:
...
class ListTableResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i151 in range(_size147):
                        ...
                        self.table_names.append(_elem152)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.table_names is not None:
            ...
            for iter153 in self.table_names:
...
class ListIndexResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i158 in range(_size154):
                        ...
                        self.index_names.append(_elem159)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.index_names is not None:
            ...
            for iter160 in self.index_names:
...
class IndexInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i165 in range(_size161):
                        _elem166 = InitParameter()
                        _elem166.read(iprot)
                        self.index_param_list.append(_elem166)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.index_param_list is not None:
            ...
            for iter167 in self.index_param_list:
                iter167.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class CreateIndexRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i172 in range(_size168):
                        _elem173 = IndexInfo()
                        _elem173.read(iprot)
                        self.index_info_list.append(_elem173)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.index_info_list is not None:
            ...
            for iter174 in self.index_info_list:
                iter174.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
...
class CreateTableRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            ...
            for iter181 in self.column_defs:
                iter181.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
...
class InsertRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i186 in range(_size182):
                        ...
                        self.column_names.append(_elem187)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.column_names is not None:
            ...
            for iter194 in self.column_names:
...
class ExplainRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i200 in range(_size196):
                        _elem201 = ParsedExpr()
                        _elem201.read(iprot)
                        self.select_list.append(_elem201)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i206 in range(_size202):
                        _elem207 = ParsedExpr()
                        _elem207.read(iprot)
                        self.group_by_list.append(_elem207)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i212 in range(_size208):
                        _elem213 = OrderByExpr()
                        _elem213.read(iprot)
                        self.order_by_list.append(_elem213)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
    ...
    def write(self, oprot):
        ...
        if self.select_list is not None:
            ...
            for iter214 in self.select_list:
                iter214.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.search_expr is not None:
        ...
        if self.group_by_list is not None:
            ...
            for iter215 in self.group_by_list:
                iter215.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.order_by_list is not None:
            ...
            for iter216 in self.order_by_list:
                iter216.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class ExplainResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i227 in range(_size223):
                        _elem228 = ColumnField()
                        _elem228.read(iprot)
                        self.column_fields.append(_elem228)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            oprot.writeFieldBegin('column_defs', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.column_defs))
            for iter229 in self.column_defs:
                iter229.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_fields is not None:
            ...
            for iter230 in self.column_fields:
                iter230.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class SelectRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i235 in range(_size231):
                        _elem236 = ParsedExpr()
                        _elem236.read(iprot)
                        self.select_list.append(_elem236)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i241 in range(_size237):
                        _elem242 = ParsedExpr()
                        _elem242.read(iprot)
                        self.group_by_list.append(_elem242)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i247 in range(_size243):
                        _elem248 = OrderByExpr()
                        _elem248.read(iprot)
                        self.order_by_list.append(_elem248)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.select_list is not None:
            oprot.writeFieldBegin('select_list', TType.LIST, 4)
            oprot.writeListBegin(TType.STRUCT, len(self.select_list))
            for iter249 in self.select_list:
                iter249.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.search_expr is not None:
        ...
        if self.group_by_list is not None:
            oprot.writeFieldBegin('group_by_list', TType.LIST, 7)
            oprot.writeListBegin(TType.STRUCT, len(self.group_by_list))
            for iter250 in self.group_by_list:
                iter250.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.having_expr is not None:
        ...
        if self.order_by_list is not None:
            oprot.writeFieldBegin('order_by_list', TType.LIST, 11)
            oprot.writeListBegin(TType.STRUCT, len(self.order_by_list))
            for iter251 in self.order_by_list:
                iter251.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class SelectResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i256 in range(_size252):
                        _elem257 = ColumnDef()
                        _elem257.read(iprot)
                        self.column_defs.append(_elem257)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i262 in range(_size258):
                        _elem263 = ColumnField()
                        _elem263.read(iprot)
                        self.column_fields.append(_elem263)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.column_defs is not None:
            oprot.writeFieldBegin('column_defs', TType.LIST, 3)
            oprot.writeListBegin(TType.STRUCT, len(self.column_defs))
            for iter264 in self.column_defs:
                iter264.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.column_fields is not None:
            oprot.writeFieldBegin('column_fields', TType.LIST, 4)
            oprot.writeListBegin(TType.STRUCT, len(self.column_fields))
            for iter265 in self.column_fields:
                iter265.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class UpdateRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i270 in range(_size266):
                        _elem271 = UpdateExpr()
                        _elem271.read(iprot)
                        self.update_expr_array.append(_elem271)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.update_expr_array is not None:
            ...
            for iter272 in self.update_expr_array:
                iter272.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.session_id is not None:
