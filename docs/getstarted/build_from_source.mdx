...
tar xf zstd-1.5.7.tar.gz && cd zstd-1.5.7 && sudo CFLAGS="-fPIC" CXXFLAGS="-fPIC" make -j lib-mt && sudo make install && cd ..
sudo ldconfig && sudo rm -rf zstd-1.5.7.tar.gz zstd-1.5.7
wget https://github.com/davea42/libdwarf-code/releases/download/v2.0.0/libdwarf-2.0.0.tar.xz
wget https://github.com/jeremy-rifkin/cpptrace/archive/refs/tags/v0.8.3.tar.gz
tar xJvf libdwarf-2.0.0.tar.xz && tar xf v0.8.3.tar.gz && cp cpptrace-0.8.3/cmake/Findzstd.cmake libdwarf-2.0.0/cmake/Findzstd.cmake && cd libdwarf-2.0.0 && mkdir build && cd build && cmake -DENABLE_DECOMPRESSION=ON -DCMAKE_POSITION_INDEPENDENT_CODE=ON .. && make -j && sudo make install && cd ../..
sudo ldconfig && sudo rm -rf libdwarf-2.0.0 cpptrace-0.8.3 libdwarf-2.0.0.tar.xz v0.8.3.tar.gz
wget https://github.com/jemalloc/jemalloc/releases/download/5.3.0/jemalloc-5.3.0.tar.bz2
tar xjf jemalloc-5.3.0.tar.bz2 && cd jemalloc-5.3.0 && ./autogen.sh && CFLAGS="-fPIC" CXXFLAGS="-fPIC" ./configure --enable-static --disable-libdl --enable-prof --enable-prof-libunwind --disable-initial-exec-tls && sudo make -j install && cd ..
sudo ldconfig && sudo rm -rf jemalloc-5.3.0.tar.bz2
