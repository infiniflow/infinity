...
- [Deploy embedded Infinity using pip](#deploy-embedded-infinity-using-pip): Mainly for local deployment or quick testing.
...
### Deploy embedded Infinity using pip
...
- CPU: x86_64 with AVX2
- Linux with glibc &ge; 2.17, Windows 10+ with WSL/WSL2, or MacOS
...
# Connect to Infinity. 
# If Infinity is deployed using pip as an embedded package, use `infinity_obj = infinity.connect("/path/to/save/your/files/to")` instead
