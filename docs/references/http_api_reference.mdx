...
- `field`: (*Body parameter*), `object[]`, *Required*
  ...
  - `"type"`: `string`, *Required*  
    ...
    - Dense vector: e.g., `"vector,128,float"`
      ...
      - The second unit in the string: The dimension of the dense vector.
      - The third unit in the string: The element type of the dense vector. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
        - `"int64"`
    ...
    - Sparse vector: e.g., `"sparse,128,float,int"`
      ...
      - The second unit in the string: The dimension of the sparse vector.
      - The third unit in the string: The element type of the sparse vector. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
        - `"int64"`
        - `"float"`/`"float32"`
        - `"double"`/`"float64"`
      - The fourth unit in the string: The data type of the sparse vector indices. Can be:
        - `int8`
        - `int16`
        - `int`/`int32`/`integer`
        - `int64`
    - Tensor vector: e.g., `"tensor,4,float"`
      ...
      - The second unit in the string: The dimension of each vector unit in the tensor.
      - The third unit in the string: The element type of the tensors. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
        - `"int64"`
    ...
    - Tensor array: e.g., `"tensorarray,6,float"`
      ...
      - The second unit in the string: The dimension of each vector unit in the tensor arrays.
      - The third unit in the string: The element type of the tensors. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
    ...
    - Multivector: e.g., `"multivector,128,float"`
      ...
      - The second unit in the string: The dimension of each vector unit.
      - The third unit in the string: The element type of the tensors. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
