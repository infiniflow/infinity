...
```shell
{
    ...
    "index_type": "HNSW",
    "other_parameters": "metric = l2, encode_type = plain, M = 16, ef_construction = 50, block_size =8192",
...
**GET** `/databases/{database_name}/tables/{table_name}/indexes/{index_name}/segment/{segment_id}/chunk/{chunk_id}`
...
curl --request DELETE \
    ...
    --header 'content-type: application/json' \
    --data ' {
        "filter": "score >= 4.0 and score <= 5.0"
} '
```
