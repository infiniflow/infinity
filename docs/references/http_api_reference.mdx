...
- `field`: (*Body parameter*), `object[]`, *Required*
  ...
  - `"type"`: `string`, *Required*  
    ...
    - Dense vector: e.g., `"vector,128,float"`
      - `128`: The dimension of the dense vector.
      - `float`: The element type of the dense vector. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
        - `"int64"`
    ...
    - Sparse vector: e.g., `"sparse,128,float,int"`
      - `128`: The dimension of the sparse vector.
      - `float`: The element type of the sparse vector. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
        - `"int64"`
        - `"float"`/`"float32"`
        - `"double"`/`"float64"`
      - `int`: The data type of the sparse vector indices. Can be:
        - `int8`
        - `int16`
        - `int`/`int32`/`integer`
        - `int64`
    - Tensor vector: e.g., `"tensor,4,float"`
      - `4`: The dimension of each vector unit in the tensor.
      - `float`: The element type of the tensors. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
        - `"int64"`
    ...
    - Tensor array: e.g., `"tensorarray,6,float"`
      - `6`: The dimension of each vector unit in the tensor arrays.
      - `float`: The element type of the tensors. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
    ...
    - Multivector: e.g., `"multivector,128,float"`
      - `128`: The dimension of each vector unit.
      - `float`: The element type of the tensors. Can be:
        - `"int8"`
        - `"int16"`
        - `"int"`/`"int32"`/`"integer"`
