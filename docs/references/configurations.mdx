...
# IP address of the Infinity peer server, accessed by peer Infinity node
peer_ip                  = "0.0.0.0"
# Port of the Infinity peer server, accessed by peer Infinity node
peer_port                = 23850

# If peer server can't connect, retry delay time
peer_retry_delay         = 0
# If peer server can't connect, retry count
peer_retry_count           = 0
# If peer server connect timeout
peer_connect_timeout     = 2000
# If peer server data receive timeout
peer_recv_timeout        = 0
# If peer server data send timeout
peer_send_timeout        = 0
