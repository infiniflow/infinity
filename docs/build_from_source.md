...
tar zxvf cmake-3.28.3-linux-x86_64.tar.gz
sudo cp -rf cmake-3.28.3-linux-x86_64/bin/* /usr/local/bin && sudo cp -rf cmake-3.28.3-linux-x86_64/share/* /usr/local/share && rm -rf cmake-3.28.3-linux-x86_64
sudo apt install -y ninja-build clang-17 clang-tools-17 libc++-17-dev flex libboost1.81-dev liblz4-dev libevent-dev liburing-dev libthrift-dev
ln -s /usr/lib/llvm-17/bin/clang-scan-deps /usr/local/bin/clang-scan-deps
```
