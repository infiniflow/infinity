...
#include <sstream>
#include <string>
#include <vespalib/util/array.hpp>
...
BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::BTreeNodeAllocator()
    : _nodeStore(), _internalToFreeze(), _leafToFreeze(), _treeToFreeze(), _internalHoldUntilFreeze(), _leafHoldUntilFreeze() {}
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
typename BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::InternalNodeTypeRefPair
BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::thawNode(BTreeNode::Ref nodeRef, InternalNodeType *node) {
    if (_internalHoldUntilFreeze.empty()) {
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
typename BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::LeafNodeTypeRefPair
BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::thawNode(BTreeNode::Ref nodeRef, LeafNodeType *node) {
    if (_leafHoldUntilFreeze.empty()) {
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
void BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::holdNode(BTreeNode::Ref nodeRef, InternalNodeType *node) {
    if (node->getFrozen()) {
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
void BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::holdNode(BTreeNode::Ref nodeRef, LeafNodeType *node) {
    if (node->getFrozen()) {
        _nodeStore.hold_entry(nodeRef);
    } else {
        node->clean();
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
void BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::reclaim_memory(generation_t oldest_used_gen) {
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
uint32_t BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::validLeaves(BTreeNode::Ref ref) const {
    if (isLeafRef(ref))
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
uint32_t BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::getLevel(BTreeNode::Ref ref) const {
    if (isLeafRef(ref))
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
const KeyT &BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::getLastKey(BTreeNode::Ref node) const {
    if (isLeafRef(node))
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
const AggrT &BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::getAggregated(BTreeNode::Ref node) const {
    if (!node.valid())
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
vespalib::MemoryUsage BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::getMemoryUsage() const {
...
template <typename KeyT, typename DataT, typename AggrT, size_t INTERNAL_SLOTS, size_t LEAF_SLOTS>
std::string BTreeNodeAllocator<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS>::toString(const BTreeNode *node) const {
    if (node == nullptr) {
        return "NULL";
    }
    std::stringstream ss;
    if (node->isLeaf()) {
        ...
        const InternalNodeType *inode = static_cast<const InternalNodeType *>(node);
