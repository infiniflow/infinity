...
#include <string>
#include <vector>
#include <vespalib/util/array.h>
#include <vespalib/util/generationhandler.h>
#include <vespalib/util/memoryusage.h>
...
public:
    ...
    const InternalNodeType *mapInternalRef(BTreeNode::Ref ref) const { return _nodeStore.mapInternalRef(ref); }

    InternalNodeType *mapInternalRef(BTreeNode::Ref ref) { return _nodeStore.mapInternalRef(ref); }

    const LeafNodeType *mapLeafRef(BTreeNode::Ref ref) const { return _nodeStore.mapLeafRef(ref); }

    LeafNodeType *mapLeafRef(BTreeNode::Ref ref) { return _nodeStore.mapLeafRef(ref); }
