...
std::string BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::toString(BTreeNode::Ref node, const NodeAllocatorType &allocator) const {
...
bool BTreeRoot<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::isValid(BTreeNode::Ref node,
                                                                          bool ignoreMinSlots,
                                                                          uint32_t level,
...
BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::findHelper(BTreeNode::Ref root,
                                                              const KeyType &key,
                                                              const NodeAllocatorType &allocator,
                                                              CompareT comp) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
typename BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::Iterator
BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::lowerBoundHelper(BTreeNode::Ref root,
                                                                    const KeyType &key,
                                                                    const NodeAllocatorType &allocator,
                                                                    CompareT comp) {
    Iterator itr(BTreeNode::Ref(), allocator);
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
typename BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::Iterator
BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::upperBoundHelper(BTreeNode::Ref root,
                                                                    const KeyType &key,
                                                                    const NodeAllocatorType &allocator,
                                                                    CompareT comp) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
typename BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::Iterator
BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::find(const KeyType &key, const NodeAllocatorType &allocator, CompareT comp) const {
    return findHelper(_root, key, allocator, comp);
}

template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
typename BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::Iterator
BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::lowerBound(const KeyType &key, const NodeAllocatorType &allocator, CompareT comp) const {
    return lowerBoundHelper(_root, key, allocator, comp);
}

template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
typename BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::Iterator
BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::upperBound(const KeyType &key, const NodeAllocatorType &allocator, CompareT comp) const {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, class AggrCalcT>
bool BTreeRoot<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::isValid(const NodeAllocatorType &allocator, CompareT comp) const {
    if (NodeAllocatorType::isValidRef(_root)) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, class AggrCalcT>
bool BTreeRoot<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::isValidFrozen(const NodeAllocatorType &allocator, CompareT comp) const {
    BTreeNode::Ref frozenRoot = getFrozenRoot();
    if (NodeAllocatorType::isValidRef(frozenRoot)) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
size_t BTreeRootT<KeyT, DataT, AggrT, CompareT, TraitsT>::bitSize(BTreeNode::Ref node, const NodeAllocatorType &allocator) const {
    if (allocator.isLeafRef(node)) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, class AggrCalcT>
bool BTreeRoot<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::insert(const KeyType &key,
                                                                         const DataType &data,
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, class AggrCalcT>
void BTreeRoot<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::insert(Iterator &itr,
                                                                         const KeyType &key,
                                                                         const DataType &data,
                                                                         const AggrCalcT &aggrCalc) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT, class AggrCalcT>
bool BTreeRoot<KeyT, DataT, AggrT, CompareT, TraitsT, AggrCalcT>::remove(const KeyType &key,
                                                                         NodeAllocatorType &allocator,
                                                                         CompareT comp,
                                                                         const AggrCalcT &aggrCalc) {
    Iterator itr(BTreeNode::Ref(), allocator);
