...
#include <vespalib/util/hdr_abort.h>

namespace vespalib::btree {

template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::BTreeIteratorBase(const BTreeIteratorBase &other)
    : _leaf(other._leaf), _pathSize(other._pathSize), _allocator(other._allocator), _leafRoot(other._leafRoot), _compatLeafNode() {
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::clearPath(uint32_t pathSize) {
...
BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::operator=(const BTreeIteratorBase &other) {
    if (&other == this) {
        return *this;
    }
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::setupEnd() {
    _leaf.invalidate();
}

template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::setupEmpty() {
    clearPath(0u);
    _leaf.invalidate();
    _leafRoot = nullptr;
}
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::end(BTreeNode::Ref rootRef) {
    if (!rootRef.valid()) {
        setupEmpty();
        return;
    }
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::findNextLeafNode() {
    uint32_t pidx;
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::findPrevLeafNode() {
    uint32_t pidx;
    for (pidx = 0; pidx < _pathSize; ++pidx) {
        PathElement &elem = _path[pidx];
        const InternalNodeType *inode = elem.getNode();
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::begin(BTreeNode::Ref rootRef) {
    if (!rootRef.valid()) {
        setupEmpty();
        return;
    }
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::rbegin() {
    uint32_t pidx = _pathSize;
    if (pidx > 0u) {
        --pidx;
        PathElement &elem = _path[pidx];
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
const AggrT &BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::getAggregated() const {
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
size_t BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::position(uint32_t levels) const {
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::BTreeIteratorBase(BTreeNode::Ref root,
...
BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::BTreeIteratorBase(const KeyDataType *shortArray,
                                                                                                uint32_t arraySize,
                                                                                                const NodeAllocatorType &allocator,
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
ssize_t BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::operator-(const BTreeIteratorBase &rhs) const {
    if (_leaf.getNode() == nullptr) {
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
bool BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::identical(const BTreeIteratorBase &rhs) const {
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::set_subtree_position(const InternalNodeType *node,
                                                                                                        uint32_t level,
                                                                                                        uint32_t idx,
                                                                                                        size_t position) {
    /*
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::step_forward(size_t steps) {
...
template <typename KeyT, typename DataT, typename AggrT, uint32_t INTERNAL_SLOTS, uint32_t LEAF_SLOTS, uint32_t PATH_SIZE>
void BTreeIteratorBase<KeyT, DataT, AggrT, INTERNAL_SLOTS, LEAF_SLOTS, PATH_SIZE>::step_backward(size_t steps) {
...
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::lower_bound(const KeyType &key, CompareT comp) {
    if (_pathSize == 0) {
        if (_leafRoot == nullptr)
            return;
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::lower_bound(BTreeNode::Ref rootRef, const KeyType &key, CompareT comp) {
    if (!rootRef.valid()) {
        setupEmpty();
        return;
    }
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::seek(const KeyType &key, CompareT comp) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::binarySeek(const KeyType &key, CompareT comp) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::linearSeek(const KeyType &key, CompareT comp) {
    const LeafNodeType *lnode = _leaf.getNode();
    uint32_t lidx = _leaf.getIdx() + 1;
    if (lidx < lnode->validSlots()) {
        if (!comp(lnode->getKey(lidx), key)) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::seekPast(const KeyType &key, CompareT comp) {
    if (TraitsT::BINARY_SEEK) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::binarySeekPast(const KeyType &key, CompareT comp) {
    const LeafNodeType *lnode = _leaf.getNode();
    uint32_t lidx = _leaf.getIdx() + 1;
    if (lidx < lnode->validSlots()) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::linearSeekPast(const KeyType &key, CompareT comp) {
    const LeafNodeType *lnode = _leaf.getNode();
    uint32_t lidx = _leaf.getIdx() + 1;
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeConstIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::validate(BTreeNode::Ref rootRef, CompareT comp) {
    bool frozen = false;
    if (!rootRef.valid()) {
        assert(_pathSize == 0u);
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
void BTreeIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::writeKey(const KeyType &key) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
template <class AggrCalcT>
void BTreeIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::updateData(const DataType &data, [[maybe_unused]] const AggrCalcT &aggrCalc) {
    LeafNodeType *lnode = getLeafNode();
    if constexpr (AggrCalcT::hasAggregated() && AggrCalcT::aggregate_over_values()) {
        ...
        if (aggrCalc.update(lnode->getAggregated(), aggrCalc.getVal(lnode->getData(_leaf.getIdx())), aggrCalc.getVal(data))) {
...
BTreeNode::Ref BTreeIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::thaw(BTreeNode::Ref rootRef) {
    ...
    while (level < levels) {
        ...
        BTreeNode::Ref nodeRef = level + 1 < levels ? _path[level + 1].getNode()->getChild(_path[level + 1].getIdx()) : rootRef;
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
template <class AggrCalcT>
BTreeNode::Ref BTreeIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::insertFirst(const KeyType &key,
                                                                                 const DataType &data,
                                                                                 [[maybe_unused]] const AggrCalcT &aggrCalc) {
    assert(_pathSize == 0);
    assert(_leafRoot == nullptr);
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
bool BTreeIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::setLeafNodeIdx(uint32_t idx, const LeafNodeType *splitLeafNode) {
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
template <class AggrCalcT>
BTreeNode::Ref BTreeIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::addLevel(BTreeNode::Ref rootRef,
...
template <typename KeyT, typename DataT, typename AggrT, typename CompareT, typename TraitsT>
BTreeNode::Ref BTreeIterator<KeyT, DataT, AggrT, CompareT, TraitsT>::removeLevel(BTreeNode::Ref rootRef, InternalNodeType *rootNode) {
