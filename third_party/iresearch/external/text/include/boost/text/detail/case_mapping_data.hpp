...
namespace boost { namespace text { namespace detail {
    ...
    using case_map_t = phmap::flat_hash_map<uint32_t, case_elements>;
    ...
    BOOST_TEXT_DECL phmap::flat_hash_set<uint32_t> make_cased_cps();
    BOOST_TEXT_DECL phmap::flat_hash_set<uint32_t> make_case_ignorable_cps();
    BOOST_TEXT_DECL phmap::flat_hash_set<uint32_t> make_changes_when_uppered_cps();
    BOOST_TEXT_DECL phmap::flat_hash_set<uint32_t> make_changes_when_lowered_cps();
    BOOST_TEXT_DECL phmap::flat_hash_set<uint32_t> make_changes_when_titled_cps();
