...
// Logging macros.
#define KALDI_ERR                                                              \
  ::fst::MessageLogger::LogAndThrow() = ::fst::MessageLogger(              \
      ::fst::LogMessageEnvelope::kError, __func__, __FILE__, __LINE__)
#define KALDI_WARN                                                             \
  ::fst::MessageLogger::Log() = ::fst::MessageLogger(                      \
      ::fst::LogMessageEnvelope::kWarning, __func__, __FILE__, __LINE__)
#define KALDI_LOG                                                              \
  ::fst::MessageLogger::Log() = ::fst::MessageLogger(                      \
      ::fst::LogMessageEnvelope::kInfo, __func__, __FILE__, __LINE__)
#define KALDI_VLOG(v)                                                          \
  if ((v) <= ::fst::GetVerboseLevel())                                       \
  ::fst::MessageLogger::Log() =                                              \
      ::fst::MessageLogger((::fst::LogMessageEnvelope::Severity)(v),       \
...
#define KALDI_ASSERT(cond)                                                     \
  do {                                                                         \
    if (cond)                                                                  \
      ...
      ::fst::KaldiAssertFailure_(__func__, __FILE__, __LINE__, #cond);       \
  } while (0)
#else
