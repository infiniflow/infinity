...
template<typename Key,
         typename Hash = typename phmap::flat_hash_set<Key>::hasher,
         typename Equal = typename phmap::flat_hash_set<Key, Hash>::key_equal>
class ref_counter : public util::noncopyable {
 ...
 private:
  ...
  phmap::flat_hash_set<ref_t, hash, equal_to> refs_;
};
