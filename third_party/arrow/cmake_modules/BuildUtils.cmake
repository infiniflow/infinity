...
function(ADD_ARROW_LIB LIB_NAME)
  ...
  if(BUILD_STATIC)
    ...
    target_include_directories(${LIB_NAME}_static PUBLIC SYSTEM "${CMAKE_SOURCE_DIR}/third_party/thrift/lib/cpp/src")
    target_include_directories(${LIB_NAME}_static PUBLIC SYSTEM "${CMAKE_BINARY_DIR}/third_party/thrift/")
