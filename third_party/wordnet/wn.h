/*
   ...
   4/21/20 modified by Bentley default path

*/

/* assure preprocessor only includes the header file once */
#ifndef _WN_
#define _WN_

#include <stdio.h>

/* removed MS Windows stuff 2020-04-14 compiling cmd line only Linux */

/* for WNtight everthing is relative to run location */
#define DICTDIR         "/dict"
#ifndef DEFAULTPATH
#define DEFAULTPATH	"/usr/local/WNtight/dict"
#endif
