...
//            *socket_,
//            std::array<boost::asio::mutable_buffer, 2>{boost::asio::buffer(&*start_pos_, std::distance(&*start_pos_, data_.end())),
...
//    } else {
//        bytes_sent =
//            boost::asio::write(*socket_, boost::asio::buffer(&*start_pos_, size()), boost::asio::transfer_at_least(bytes_to_send), boost_error);
//    }
//
