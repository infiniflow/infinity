...
IndexMethod StringToIndexMethod(const String &str) {
    if (IsEqual(str, "IVFFlat")) {
        return IndexMethod::kIVFFlat;
    } else if (IsEqual(str, "IVFSQ8")) {
        return IndexMethod::kIVFSQ8;
    } else if (IsEqual(str, "HNSW")) {
