...
public:
    explicit KnnFlatL2Blas(const DistType *queries, i64 query_count, i64 topk, i64 dimension, EmbeddingDataType elem_data_type)
        : KnnDistance<DistType>(KnnDistanceAlgoType::kKnnFlatL2Blas, elem_data_type, query_count, topk, dimension), queries_(queries) {
    ...
    void Search(const DistType *base, i16 base_count, i32 segment_id, i16 block_id) final {
        if (!begin_) {
            Error<ExecutorException>("KnnFlatL2Blas isn't begin", __FILE_NAME__, __LINE__);
        }
