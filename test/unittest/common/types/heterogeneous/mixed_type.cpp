...
TEST_F(MixedTypeTest, mixed_tuple3) {
    ...
    EXPECT_THROW(mixed_tuple3.InsertIntegerIntoTuple("key1key1", 400), TypeException);
    ...
    EXPECT_THROW(mixed_tuple3.InsertIntegerIntoTuple("key1key1key1key1key1key2", 900), TypeException);
    ...
    EXPECT_THROW(mixed_tuple3.InsertStringIntoTuple("keyX", "ABC"), TypeException);

    // Validate to throw type exception, when create 0 capacity tuple.
    EXPECT_THROW(MixedType::MakeTuple(0), TypeException);
}
...
TEST_F(MixedTypeTest, mixed_array3) {
    ...
    EXPECT_THROW(mixed_array1.InsertFloatIntoArray(1.5, 2), TypeException);
    EXPECT_THROW(MixedType::MakeArray(0), TypeException);
}
