...
TEST_F(AddFunctionsTest, add_func) {
...

    {
        ...
        DataType data1_type(LogicalType::kDate);
        DataType data2_type(LogicalType::kInterval);
        SharedPtr<ColumnExpression> col1_expr_ptr = MakeShared<ColumnExpression>(data1_type,
                                                                                 "t1",
                                                                                 "c1",
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("+(Date, Interval)->Date", func.ToString().c_str());
    }

    {
        ...
        DataType data1_type(LogicalType::kInterval);
        DataType data2_type(LogicalType::kDate);
        SharedPtr<ColumnExpression> col1_expr_ptr = MakeShared<ColumnExpression>(data1_type,
                                                                                 "t1",
                                                                                 "c1",
                                                                                 0,
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("+(Interval, Date)->Date", func.ToString().c_str());
    }

    {
        Vector<SharedPtr<BaseExpression>> inputs;

        DataType data1_type(LogicalType::kTime);
        DataType data2_type(LogicalType::kInterval);
        SharedPtr<ColumnExpression> col1_expr_ptr = MakeShared<ColumnExpression>(data1_type,
                                                                                 "t1",
                                                                                 "c1",
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("+(Time, Interval)->Time", func.ToString().c_str());
    }

    {
        ...
        DataType data1_type(LogicalType::kInterval);
        DataType data2_type(LogicalType::kTime);
        SharedPtr<ColumnExpression> col1_expr_ptr = MakeShared<ColumnExpression>(data1_type,
                                                                                 "t1",
                                                                                 "c1",
                                                                                 0,
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("+(Interval, Time)->Time", func.ToString().c_str());
    }
...

    {
        ...
        DataType data1_type(LogicalType::kInterval);
        DataType data2_type(LogicalType::kTimestampTZ);
        SharedPtr<ColumnExpression> col1_expr_ptr = MakeShared<ColumnExpression>(data1_type,
                                                                                 "t1",
                                                                                 "c1",
                                                                                 0,
        ...
        ScalarFunction func = scalar_function_set->GetMostMatchFunction(inputs);
        EXPECT_STREQ("+(Interval, TimestampTZ)->TimestampTZ", func.ToString().c_str());
    }
