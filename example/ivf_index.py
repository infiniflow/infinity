...
try:
    ...
    # Create an ivf index on the table
    # "CREATE INDEX index1 ON my_table (c2) USING IVF WITH (metric = l2)"
    ...
    res, extra_result = table_instance.output(["c1"]).match_dense("c2", [0.3, 0.3, 0.2, 0.2], "float", "l2", 3).to_pl()
    print(res)
