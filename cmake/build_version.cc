...
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:nightly";
...
static const std::string rocksdb_build_date = "rocksdb_build_date:2025-06-11 03:36:02";
#endif
