...
https://github.com/apache/thrift/archive/refs/tags/v0.20.0.tar.gz   thrift-0.20.0.tar.gz
...
https://github.com/davea42/libdwarf-code/releases/download/v2.0.0/libdwarf-2.0.0.tar.xz
