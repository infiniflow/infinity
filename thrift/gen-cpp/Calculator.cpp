...
void CalculatorClient::Connect(CommonResponse& _return, const CommonRequest& req)
{
  send_Connect(req);
  recv_Connect(_return);
}

void CalculatorClient::send_Connect(const CommonRequest& req)
{
  int32_t cseqid = 0;
...
void CalculatorClient::CreateDatabase(CommonResponse& _return, const CreateDatabaseRequest& req)
{
  send_CreateDatabase(req);
  recv_CreateDatabase(_return);
}

void CalculatorClient::send_CreateDatabase(const CreateDatabaseRequest& req)
{
  int32_t cseqid = 0;
...
void CalculatorProcessor::process_Connect(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->Connect(result.success, args.req);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != nullptr) {
...
void CalculatorProcessor::process_CreateDatabase(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->CreateDatabase(result.success, args.req);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != nullptr) {
...
void CalculatorConcurrentClient::Connect(CommonResponse& _return, const CommonRequest& req)
{
  int32_t seqid = send_Connect(req);
  recv_Connect(_return, seqid);
}

int32_t CalculatorConcurrentClient::send_Connect(const CommonRequest& req)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("Connect", ::apache::thrift::protocol::T_CALL, cseqid);
...
void CalculatorConcurrentClient::CreateDatabase(CommonResponse& _return, const CreateDatabaseRequest& req)
{
  int32_t seqid = send_CreateDatabase(req);
  recv_CreateDatabase(_return, seqid);
}

int32_t CalculatorConcurrentClient::send_CreateDatabase(const CreateDatabaseRequest& req)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("CreateDatabase", ::apache::thrift::protocol::T_CALL, cseqid);
