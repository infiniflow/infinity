...
std::shared_ptr<std::vector<std::string>> PhysicalHashJoin::GetOutputNames() const {
...
std::shared_ptr<std::vector<std::shared_ptr<DataType>>> PhysicalHashJoin::GetOutputTypes() const {
