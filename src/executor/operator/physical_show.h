...
public:
    explicit PhysicalShow(u64 id, ShowType type, String db_name, String object_name, u64 table_index)
        : PhysicalOperator(PhysicalOperatorType::kShow, nullptr, nullptr, id), scan_type_(type), db_name_(std::move(db_name)),
          object_name_(std::move(object_name)), table_index_(table_index) {}
