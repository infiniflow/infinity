...
std::shared_ptr<std::vector<std::string>> PhysicalNestedLoopJoin::GetOutputNames() const {
...
std::shared_ptr<std::vector<std::shared_ptr<DataType>>> PhysicalNestedLoopJoin::GetOutputTypes() const {
