...
class PhysicalMergeHash final : public PhysicalOperator {
public:
    explicit PhysicalMergeHash(SharedPtr<Vector<String>> output_names, SharedPtr<Vector<SharedPtr<DataType>>> output_types, u64 id)
        : PhysicalOperator(PhysicalOperatorType::kMergeHash, nullptr, nullptr, id), output_names_(std::move(output_names)),
