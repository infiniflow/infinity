...
class PhysicalParallelAggregate final : public PhysicalOperator {
public:
    explicit
    PhysicalParallelAggregate(SharedPtr<Vector<String>> output_names,
                              SharedPtr<Vector<SharedPtr<DataType>>> output_types,
                              u64 id)
            : PhysicalOperator(PhysicalOperatorType::kParallelAggregate, nullptr, nullptr, id),
