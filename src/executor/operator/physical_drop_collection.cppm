...
export module infinity_core:physical_drop_collection;
...
public:
    explicit PhysicalDropCollection(std::shared_ptr<std::string> schema_name,
    ...
    inline std::shared_ptr<std::string> collection_name() const { return collection_name_; }
