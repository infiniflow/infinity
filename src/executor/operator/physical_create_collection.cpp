...
PhysicalCreateCollection::PhysicalCreateCollection(SharedPtr<String> schema_name,
                                                   ...
                                                   u64 table_index,
                                                   u64 id)
    : PhysicalOperator(PhysicalOperatorType::kCreateCollection, nullptr, nullptr, id), schema_name_(std::move(schema_name)),
      collection_name_(std::move(collection_name)), output_names_(std::move(output_names)), output_types_(std::move(output_types)),
      conflict_type_(conflict_type), table_index_(table_index) {}
