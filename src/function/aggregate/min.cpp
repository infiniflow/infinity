...
public:
    ...
    void Initialize() { NotImplementError("Initialize min state.") }

    void Update(const ValueType *__restrict input, SizeT idx) { NotImplementError("Update min state.") }

    inline void ConstantUpdate(const ValueType *__restrict input, SizeT idx, SizeT count) { NotImplementError("Constant update min state.") }

    [[nodiscard]] ptr_t Finalize() const { NotImplementError("Finalize min state.") }

    inline static SizeT Size(const DataType &data_type) { NotImplementError("Min state type size: " + data_type.ToString()) }
};
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<TinyIntT>::max(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<SmallIntT>::max(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<IntegerT>::max(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<BigIntT>::max(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<FloatT>::max(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<DoubleT>::max(); }
