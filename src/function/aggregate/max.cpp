...
public:
    ...
    void Initialize() { NotImplementError("Initialize max state.") }

    void Update(const ValueType *__restrict input, SizeT idx) { NotImplementError("Update max state.") }

    inline void ConstantUpdate(const ValueType *__restrict input, SizeT idx, SizeT count) { NotImplementError("Constant update max state.") }

    [[nodiscard]] ptr_t Finalize() const { NotImplementError("Finalize max state.") }

    inline static SizeT Size(const DataType &data_type) { NotImplementError("Max state type size: " + data_type.ToString()) }
};
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<TinyIntT>::min(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<SmallIntT>::min(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<IntegerT>::min(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<BigIntT>::min(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<FloatT>::min(); }
...
public:
    ...
    void Initialize() { this->value_ = std::numeric_limits<DoubleT>::min(); }
