...
CastTable::CastTable() {
    ...
    matrix_[kVarchar][kDecimal16] = 2;
    matrix_[kVarchar][kDecimal32] = 2;
    matrix_[kVarchar][kDecimal64] = 2;
    matrix_[kVarchar][kDecimal128] = 2;
    matrix_[kVarchar][kVarchar] = 0;
    matrix_[kVarchar][kChar] = 1;
    matrix_[kVarchar][kDate] = 2;
    matrix_[kVarchar][kTime] = 2;
    matrix_[kVarchar][kDateTime] = 2;
    matrix_[kVarchar][kTimestamp] = 2;
    matrix_[kVarchar][kTimestampTZ] = 2;
