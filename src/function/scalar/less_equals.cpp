...
template<>
inline void
LessEqualsFunction::Run(VarcharT left, VarcharT right, bool & result) {
    if(left.IsInlined()) {
        if(right.IsInlined()) {
...
template<>
inline void
LessEqualsFunction::Run(MixedT left, BigIntT right, bool& result) {
    NotImplementError("Not implement: mixed == bigint")
}

template<>
inline void
LessEqualsFunction::Run(BigIntT left, MixedT right, bool& result) {
    LessEqualsFunction::Run(right, left, result);
}

template<>
inline void
LessEqualsFunction::Run(MixedT left, DoubleT right, bool& result) {
    NotImplementError("Not implement: mixed == double")
}

template<>
inline void
LessEqualsFunction::Run(DoubleT left, MixedT right, bool& result) {
    LessEqualsFunction::Run(right, left, result);
}

template<>
inline void
LessEqualsFunction::Run(MixedT left, VarcharT right, bool& result) {
    NotImplementError("Not implement: mixed == varchar")
}

template<>
inline void
LessEqualsFunction::Run(VarcharT left, MixedT right, bool& result) {
    LessEqualsFunction::Run(right, left, result);
}
