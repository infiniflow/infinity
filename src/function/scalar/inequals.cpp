...
template<>
inline void
InEqualsFunction::Run(MixedT left, BigIntT right, bool& result) {
    NotImplementError("Not implement: mixed == bigint")
}

template<>
inline void
InEqualsFunction::Run(BigIntT left, MixedT right, bool& result) {
    InEqualsFunction::Run(right, left, result);
}

template<>
inline void
InEqualsFunction::Run(MixedT left, DoubleT right, bool& result) {
    NotImplementError("Not implement: mixed == double")
}

template<>
inline void
InEqualsFunction::Run(DoubleT left, MixedT right, bool& result) {
    InEqualsFunction::Run(right, left, result);
}

template<>
inline void
InEqualsFunction::Run(MixedT left, VarcharT right, bool& result) {
    NotImplementError("Not implement: mixed == varchar")
}

template<>
inline void
InEqualsFunction::Run(VarcharT left, MixedT right, bool& result) {
    InEqualsFunction::Run(right, left, result);
}

template<typename CompareType>
static void
GenerateInEqualsFunction(std::shared_ptr<ScalarFunctionSet>& function_set_ptr, DataType data_type) {
...
void
RegisterInEqualsFunction(const std::unique_ptr<Catalog> &catalog_ptr) {
