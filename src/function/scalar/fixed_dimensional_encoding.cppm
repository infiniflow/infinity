...
export struct FixedDimensionalEncodingConfig {
    ...
    enum class EncodingType { DEFAULT_SUM = 0, AVERAGE = 1 };
    ...
    enum class ProjectionType { DEFAULT_IDENTITY = 0, AMS_SKETCH = 1 };
    ...
    bool has_final_projection_dimension() const { return final_projection_dimension.has_value(); }
};
...
public:
    Tensor(const std::vector<float> &data, i32 dimension) : buffer_(data), dimension_(dimension) {
...
export std::optional<std::vector<float>> GenerateFixedDimensionalEncoding(const std::vector<float> &tensor_data,
                                                                          const FixedDimensionalEncodingConfig &config);

export std::optional<std::vector<float>> GenerateQueryFixedDimensionalEncoding(const std::vector<float> &tensor_data,
                                                                               const FixedDimensionalEncodingConfig &config);

export std::optional<std::vector<float>> GenerateDocumentFixedDimensionalEncoding(const std::vector<float> &tensor_data,
                                                                                  const FixedDimensionalEncodingConfig &config);
