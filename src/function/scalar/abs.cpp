...
RegisterAbsFunction() {
    ...
    function_set.AddFunction(abs_int16);
    ...
    function_set.AddFunction(abs_int32);
    ...
    function_set.AddFunction(abs_int64);
    ...
    function_set.AddFunction(abs_float);
    ...
    ScalarFunction abs_double(
            ...
            { LogicalType(LogicalTypeId::kDouble) },
            &ScalarFunction::UnaryFunction<float, float, AbsFunctionFloat>);
    function_set.AddFunction(abs_double);
