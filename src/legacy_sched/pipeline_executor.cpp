...
bool
PipelineExecutor::CancelQuery(QueryContext* query_context) {
    return false;
}

void
PipelineExecutor::DispatchTask(std::uint16_t worker_id, PipelineTaskPtr task) {
