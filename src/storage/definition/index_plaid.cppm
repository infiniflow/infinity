...
export module infinity_core:index_plaid;
...
export class IndexPLAID final : public IndexBase {
public:
    IndexPLAID(std::shared_ptr<std::string> index_name,
