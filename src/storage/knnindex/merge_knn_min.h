...
class MergeKnnMin : public MergeKnn<DistType> {
...
public:
    explicit MergeKnnMin(i64 query_count, i64 topk) : MergeKnn<DistType>(query_count, topk) {
...
template class MergeKnnMin<f32>;
} // namespace infinity