...
void faiss_exhaustive_L2sqr_blas_cmax_avx2_int32(const float *x,
                                                 const float *y,
                                                 size_t d,
                                                 size_t nx,
                                                 size_t ny,
                                                 TopKSingleBestResultHandler<CMax<float, int32_t>> &res,
...
void faiss_exhaustive_L2sqr_blas_cmax_avx2_int64(const float *x,
                                                 const float *y,
                                                 size_t d,
                                                 size_t nx,
                                                 size_t ny,
                                                 TopKSingleBestResultHandler<CMax<float, int64_t>> &res,
                                                 const float *y_norms = nullptr) {
    int distance_compute_blas_query_bs = 4096;
    int distance_compute_blas_database_bs = 1024;
    // BLAS does not like empty matrices
