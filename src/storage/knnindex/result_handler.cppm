...
public:
    ...
    void ReInitialize() {
        ...
        std::fill_n(distance_ptr, n_queries * top_k, Compare::InitialValue());
    }
...
export template <class Compare>
struct SingleBestResultHandler : public ResultHandlerBase {
    using DistType = typename Compare::DistanceType;
    using ID = typename Compare::IDType;
    SizeT n_queries{};
    DistType *distance_ptr = nullptr;
...
export template <class Compare>
struct ReservoirResultHandler : public ResultHandlerBase {
    using DistType = typename Compare::DistanceType;
    using ID = typename Compare::IDType;
    SizeT n_queries;
    SizeT top_k;
    ...
    static DistType sample_threshold_median3(const DistType *vals, int n, DistType thresh_inf, DistType thresh_sup) {
