...
public:
    explicit
    KnnFlatL2BlasReservoir(const DistType* queries,
                           i64 query_count,
                           i64 topk,
                           i64 dimension,
                           EmbeddingDataType elem_data_type)
            : KnnDistance<DistType>(KnnDistanceAlgoType::kKnnFlatL2BlasReservoir, elem_data_type),
              queries_(queries),
...
template
class KnnFlatL2BlasReservoir<f32>;
