...
SharedPtr<BaseTable> Schema::GetTableByName(const String &name) {
...
void Schema::AddTable(const SharedPtr<BaseTable> &table, ConflictType conflict_type) {
...
void Schema::DeleteTable(const String &table_name, ConflictType conflict_type) {
    if (tables_.find(table_name) == tables_.end()) {
...
SharedPtr<View> Schema::GetViewByName(const String &name) {
...
void Schema::AddView(const SharedPtr<View> &view, ConflictType conflict_type) {
...
void Schema::DeleteView(const String &view_name, ConflictType conflict_type) {
    if (views_.find(view_name) == views_.end()) {
