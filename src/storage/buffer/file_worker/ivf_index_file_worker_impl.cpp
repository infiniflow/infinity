...
bool IVFIndexFileWorker::Write(std::span<IVFIndexInChunk> data, bool &prepare_success, const FileWorkerSaveCtx &ctx) {
...
void IVFIndexFileWorker::Read(std::shared_ptr<IVFIndexInChunk> &data, size_t file_size) {
