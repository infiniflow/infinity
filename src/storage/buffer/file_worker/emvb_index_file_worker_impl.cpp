...
bool EMVBIndexFileWorker::Write(std::span<EMVBIndex> data, bool &prepare_success, const FileWorkerSaveCtx &ctx) {
...
void EMVBIndexFileWorker::Read(std::shared_ptr<EMVBIndex> &data, size_t file_size) {
