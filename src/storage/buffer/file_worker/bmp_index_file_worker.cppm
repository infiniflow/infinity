...
protected:
    bool Write(std::span<BMPHandlerPtr> data, bool &prepare_success, const FileWorkerSaveCtx &ctx) override;

    void Read(std::shared_ptr<BMPHandlerPtr> &data, size_t file_size) override;
