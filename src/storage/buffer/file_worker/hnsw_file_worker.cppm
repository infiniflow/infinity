...
protected:
    bool Write(std::span<HnswHandlerPtr> data, bool &prepare_success, const FileWorkerSaveCtx &ctx) override;

    void Read(std::shared_ptr<HnswHandlerPtr> &data, size_t file_size) override;
