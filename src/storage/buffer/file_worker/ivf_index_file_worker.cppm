...
protected:
    bool Write(std::span<IVFIndexInChunk> data, bool &prepare_success, const FileWorkerSaveCtx &ctx) override;

    void Read(std::shared_ptr<IVFIndexInChunk> &data, size_t file_size) override;
};
