...
public:
    ...
    void
    WriteLong(const int64_t i) {
        WriteInt((int32_t)(i >> 32));
        WriteInt((int32_t)i);
    }

    void
    WriteVLong(const int64_t vi) {
        uint64_t i = vi;
        while((i & ~0x7F) != 0) {
