...
using AbstractHnsw = std::variant<SharedPtr<KnnHnsw<PlainCosVecStoreType<float>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<float>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<float>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<u8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<u8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<u8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<i8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<i8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<i8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<LVQCosVecStoreType<float, i8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<LVQIPVecStoreType<float, i8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<LVQL2VecStoreType<float, i8>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<float, true>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<float, true>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<float, true>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<u8, true>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<u8, true>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<u8, true>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<i8, true>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<i8, true>, SegmentOffset>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<i8, true>, SegmentOffset>>,

                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<float>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<float>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<float>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<u8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<u8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<u8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<i8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<i8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<i8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<LVQCosVecStoreType<float, i8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<LVQIPVecStoreType<float, i8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<LVQL2VecStoreType<float, i8>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<float, true>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<float, true>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<float, true>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<u8, true>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<u8, true>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<u8, true>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainCosVecStoreType<i8, true>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainIPVecStoreType<i8, true>, SegmentOffset, false>>,
                                  SharedPtr<KnnHnsw<PlainL2VecStoreType<i8, true>, SegmentOffset, false>>,
                                  std::nullptr_t>;
