...
private:
    ...
    bool CheckConflictCmd(const WalCmd &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdCreateDatabaseV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdDropDatabaseV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdCreateTableV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdAppendV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdImportV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdAddColumnsV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdDropColumnsV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdCompactV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdCreateIndexV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdDumpIndexV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdDeleteV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictCmd(const WalCmdDropTableV2 &cmd, const NewTxn *previous_txn, std::string &cause, bool &retry_query);

    bool CheckConflictTxnStore(const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const CreateDBTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const DropDBTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const CreateTableTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const AppendTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const ImportTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const AddColumnsTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const DropColumnsTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const CompactTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const CreateIndexTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const DropIndexTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const OptimizeIndexTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const DumpMemIndexTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const DeleteTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const DropTableTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const RenameTableTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const UpdateTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const RestoreTableTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const RestoreDatabaseTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
    bool CheckConflictTxnStore(const CreateTableSnapshotTxnStore &txn_store, const NewTxn *previous_txn, std::string &cause, bool &retry_query);
