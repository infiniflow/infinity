...
struct WalCmdCreateDatabase : public WalCmd {
    ...
    virtual WalCommandType
    GetType() { return WalCommandType::CREATE_DATABASE; }
    virtual bool
    operator==(const WalCmd& other) const {
...
struct WalCmdDropDatabase : public WalCmd {
    ...
    virtual WalCommandType
    GetType() { return WalCommandType::DROP_DATABASE; }
    virtual bool
    operator==(const WalCmd& other) const {
...
struct WalCmdCreateTable : public WalCmd {
    ...
    virtual WalCommandType
    GetType() { return WalCommandType::CREATE_TABLE; }
...
struct WalCmdDropTable : public WalCmd {
    ...
    virtual WalCommandType
    GetType() { return WalCommandType::DROP_TABLE; }
    virtual bool
    operator==(const WalCmd& other) const {
...
struct WalCmdAppend : public WalCmd {
    ...
    virtual WalCommandType
    GetType() { return WalCommandType::APPEND; }
...
struct WalCmdDelete : public WalCmd {
    ...
    virtual WalCommandType
    GetType() { return WalCommandType::DELETE; }
