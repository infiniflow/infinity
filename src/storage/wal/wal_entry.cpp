...
SharedPtr<WalCmd>
WalCmd::ReadAdv(char*& ptr, int32_t maxbytes) {
...
bool
WalCmdCreateTable::operator==(const WalCmd& other) const {
...
bool
WalCmdImport::operator==(const WalCmd& other) const {
...
bool
WalCmdDelete::operator==(const WalCmd& other) const {
...
int32_t
WalCmdCreateDatabase::GetSizeInBytes() const {
    return sizeof(WalCommandType) + sizeof(int32_t) + this->db_name.size();
}

int32_t
WalCmdDropDatabase::GetSizeInBytes() const {
    return sizeof(WalCommandType) + sizeof(int32_t) + this->db_name.size();
}

int32_t
WalCmdCreateTable::GetSizeInBytes() const {
    return sizeof(WalCommandType) + sizeof(int32_t) + this->db_name.size() +
           this->table_def->GetSizeInBytes();
}

int32_t
WalCmdDropTable::GetSizeInBytes() const {
    return sizeof(WalCommandType) + sizeof(int32_t) + this->db_name.size() +
           sizeof(int32_t) + this->table_name.size();
}

int32_t
WalCmdImport::GetSizeInBytes() const {
    return sizeof(WalCommandType) + sizeof(int32_t) + this->db_name.size() +
           sizeof(int32_t) + this->table_name.size() +
...
int32_t
WalCmdDelete::GetSizeInBytes() const {
    return sizeof(WalCommandType) + sizeof(int32_t) + this->db_name.size() +
           sizeof(int32_t) + this->table_name.size() + sizeof(int32_t) +
...
void
WalCmdCreateDatabase::WriteAdv(char*& buf) const {
    WriteBufAdv(buf, WalCommandType::CREATE_DATABASE);
    WriteBufAdv(buf, this->db_name);
}

void
WalCmdDropDatabase::WriteAdv(char*& buf) const {
    WriteBufAdv(buf, WalCommandType::DROP_DATABASE);
    WriteBufAdv(buf, this->db_name);
}

void
WalCmdCreateTable::WriteAdv(char*& buf) const {
...
void
WalCmdDropTable::WriteAdv(char*& buf) const {
...
void
WalCmdImport::WriteAdv(char*& buf) const {
...
void
WalCmdDelete::WriteAdv(char*& buf) const {
...
bool
WalEntry::operator==(const WalEntry& other) const {
...
void
WalEntry::WriteAdv(char*& ptr) const {
