...
public:
    ...
    [[nodiscard]] inline VirtualStorageSystem *virtual_storage_system() noexcept { return virtual_storage_system_.get(); }
...
private:
    ...
    UniquePtr<VirtualStorageSystem> virtual_storage_system_{};
