...
void DocListSkipListReader::Load(const ByteSliceList* byte_slice_list, uint32_t start, uint32_t end, const uint32_t& item_count) {
    start_ = start;
    end_ = end;
...
void DocListSkipListReader::Load(ByteSlice* byte_slice, uint32_t start, uint32_t end, const uint32_t& item_count) {
    start_ = start;
    end_ = end;
...
void DocListSkipListReader::Load_(uint32_t start, uint32_t end , const uint32_t& item_count) {
    InitMember();
...
bool DocListSkipListReader::SkipTo(uint32_t query_doc_id, uint32_t& doc_id, uint32_t& prev_doc_id, uint32_t& offset, uint32_t& delta) {
...
std::pair<int, bool> DocListSkipListReader::LoadBuffer() {
