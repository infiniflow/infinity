...
void
PosSkipListReader::Load(const ByteSliceList* byte_slice_list,
                        uint32_t start,
                        uint32_t end,
...
void
PosSkipListReader::Load(ByteSlice* byte_slice, uint32_t start, uint32_t end, const uint32_t& item_count) {
    start_ = start;
    end_ = end;
...
void
PosSkipListReader::Load_(uint32_t start, uint32_t end, const uint32_t& item_count) {
...
bool
PosSkipListReader::SkipTo(uint32_t query_key, uint32_t& key, uint32_t& prev_key, uint32_t& value, uint32_t& delta) {
