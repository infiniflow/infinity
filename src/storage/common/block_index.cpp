...
void
BlockIndex::Insert(SegmentEntry* segment_entry, TxnTimeStamp timestamp) {
...
BlockEntry*
BlockIndex::GetBlockEntry(i32 segment_id, i16 block_id) const {
