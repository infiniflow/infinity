...
module infinity_core:inmem_index_segment_reader.impl;
...
bool InMemIndexSegmentReader::GetSegmentPosting(const std::string &term, SegmentPosting &seg_posting, bool fetch_position) const {
    std::shared_ptr<PostingWriter> writer;
