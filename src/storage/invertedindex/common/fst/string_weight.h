...
public:
    ...
    friend bool operator==(const StringLeftWeight &lhs, const StringLeftWeight &rhs) noexcept { return lhs.str_ == rhs.str_; }
    ...
    explicit StringLeftWeight(infinity::basic_string_view<Label> rhs) : str_(rhs.data(), rhs.size()) {}

    StringLeftWeight &operator=(StringLeftWeight &&) = default;
    StringLeftWeight &operator=(const StringLeftWeight &) = default;

    StringLeftWeight &operator=(infinity::basic_string_view<Label> rhs) {
        str_.assign(rhs.data(), rhs.size());
        return *this;
    }

    bool Member() const noexcept { return StringLeftWeightTraits<Label>::Member(*this); }
    ...
    StringLeftWeight Quantize(float delta = kDelta) const noexcept { return *this; }
...
template <typename Label>
bool StringLeftWeightTraits<Label>::Member(const StringLeftWeight<Label> &weight) {
    return weight != NoWeight();
}

template <typename Label>
inline bool operator!=(const StringLeftWeight<Label> &w1, const StringLeftWeight<Label> &w2) {
    return !(w1 == w2);
}

template <typename Label>
inline std::ostream &operator<<(std::ostream &strm, const StringLeftWeight<Label> &weight) {
    if (weight.Empty()) {
        return strm << "Epsilon";
    }
...
template <typename Label>
inline std::istream &operator>>(std::istream &strm, StringLeftWeight<Label> &weight) {
    std::string str;
    strm >> str;
    if (str == "Infinity") {
...
template <typename Label>
inline StringLeftWeight<Label> Plus(const StringLeftWeight<Label> &lhs, const StringLeftWeight<Label> &rhs) {
...
template <typename Label>
inline StringLeftWeight<Label> Times(const StringLeftWeight<Label> &lhs, const StringLeftWeight<Label> &rhs) {
    typedef StringLeftWeight<Label> Weight;
...
template <typename Label>
inline StringLeftWeight<Label> DivideLeft(const StringLeftWeight<Label> &lhs, const StringLeftWeight<Label> &rhs) {
    typedef StringLeftWeight<Label> Weight;
...
template <typename Label>
inline StringLeftWeight<Label> Divide(const StringLeftWeight<Label> &lhs, const StringLeftWeight<Label> &rhs, DivideType typ) {
    return DivideLeft(lhs, rhs);
}

template <>
struct StringLeftWeightTraits<infinity::byte_type> {
    static const StringLeftWeight<infinity::byte_type> &Zero() noexcept {
        static const StringLeftWeight<infinity::byte_type> zero;
        return zero;
    }

    static const StringLeftWeight<infinity::byte_type> &One() noexcept { return Zero(); }

    static const StringLeftWeight<infinity::byte_type> &NoWeight() noexcept { return Zero(); }

    static bool Member(const StringLeftWeight<infinity::byte_type> &) noexcept {
        // always member
        return true;
    }
};

inline std::ostream &operator<<(std::ostream &strm, const StringLeftWeight<infinity::byte_type> &weight) {
    if (weight.Empty()) {
        return strm << "Epsilon";
    }
...
inline std::istream &operator>>(std::istream &strm, StringLeftWeight<infinity::byte_type> &weight) {
    std::string str;
    strm >> str;
    if (str == "Epsilon") {
        weight = StringLeftWeight<infinity::byte_type>::One();
    } else {
        weight.Clear();
        char *p = nullptr;
        for (const char *cs = str.c_str(); !p || *p != '\0'; cs = p + 1) {
...
inline infinity::bytes_view Plus(const StringLeftWeight<infinity::byte_type> &lhs, const StringLeftWeight<infinity::byte_type> &rhs) {
    return PlusImpl(lhs, rhs);
}

inline infinity::bytes_view Plus(infinity::bytes_view lhs, const StringLeftWeight<infinity::byte_type> &rhs) { return PlusImpl(lhs, rhs); }

inline infinity::bytes_view Plus(const StringLeftWeight<infinity::byte_type> &lhs, infinity::bytes_view rhs) { return PlusImpl(lhs, rhs); }

// For binary strings that's impossible to use
// Zero() or NoWeight() as they may interfere
// with real values
inline StringLeftWeight<infinity::byte_type> TimesImpl(infinity::bytes_view lhs, infinity::bytes_view rhs) {
    using Weight = StringLeftWeight<infinity::byte_type>;
...
inline StringLeftWeight<infinity::byte_type> Times(const StringLeftWeight<infinity::byte_type> &lhs,
                                                   const StringLeftWeight<infinity::byte_type> &rhs) {
    return TimesImpl(lhs, rhs);
}

inline StringLeftWeight<infinity::byte_type> Times(infinity::bytes_view lhs, const StringLeftWeight<infinity::byte_type> &rhs) {
    return TimesImpl(lhs, rhs);
}

inline StringLeftWeight<infinity::byte_type> Times(const StringLeftWeight<infinity::byte_type> &lhs, infinity::bytes_view rhs) {
    return TimesImpl(lhs, rhs);
}
...
inline infinity::bytes_view DivideLeft(const StringLeftWeight<infinity::byte_type> &lhs, const StringLeftWeight<infinity::byte_type> &rhs) {
    return DivideLeftImpl(lhs, rhs);
}

inline infinity::bytes_view DivideLeft(infinity::bytes_view lhs, const StringLeftWeight<infinity::byte_type> &rhs) {
    return DivideLeftImpl(lhs, rhs);
}

inline infinity::bytes_view DivideLeft(const StringLeftWeight<infinity::byte_type> &lhs, infinity::bytes_view rhs) {
    return DivideLeftImpl(lhs, rhs);
}

inline infinity::bytes_view DivideLeft(infinity::bytes_view lhs, infinity::bytes_view rhs) { return DivideLeftImpl(lhs, rhs); }

inline StringLeftWeight<infinity::byte_type>
Divide(const StringLeftWeight<infinity::byte_type> &lhs, const StringLeftWeight<infinity::byte_type> &rhs, DivideType typ) {
    return StringLeftWeight<infinity::byte_type>(DivideLeft(lhs, rhs));
}
