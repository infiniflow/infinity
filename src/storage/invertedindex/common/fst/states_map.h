...
//////////////////////////////////////////////////////////////////////////////
template <typename Fst, typename State, typename PushState, typename Hash, typename StateEq, typename Fst::StateId NoStateId>
class FSTStatesMap {
public:
    using fst_type = Fst;
    ...
    explicit FSTStatesMap(size_t capacity = 16,
        ...
        : hasher_{hash_function}, state_eq_{state_eq}, push_state_{state_emplace}, states_(capacity, NoStateId) {}
    ...
    state_id Insert(const state_type &s, fst_type &fst) {
        ...
        for (;; ++pos, pos %= mask) {
            ...
            if (NoStateId == bucket) {
                ...
                // StorageAssert(hasher_(s, fst) == hasher_(id, fst));
                ++count_;
...
private:
    ...
    hasher hasher_;
    state_equal state_eq_;
    push_state push_state_;
