...
export struct QueryNode {
    ...
    // Clone the query tree for reuse
    [[nodiscard]] virtual std::unique_ptr<QueryNode> Clone() const = 0;
};
...
export struct MultiQueryNode : public QueryNode {
    ...
    [[nodiscard]] virtual std::unique_ptr<QueryNode> Clone() const override = 0;
};
