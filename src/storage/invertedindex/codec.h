...
public:
    ...
    void EncodeColumnKey(const u64 schema_id, const u64 table_id, const u64 column_id, const std::string &term, std::string &key);

    void DecodeColumnKey(const std::string &key, std::string &term);
