...
public:
    ...
    uint32_t GetPrevDocId() const { return prev_doc_id_; }

    uint32_t GetCurrentDocId() const { return current_doc_id_; }

    uint32_t GetCurrentTTF() const { return current_ttf_; }

    uint32_t GetPrevTTF() const { return prev_ttf_; }
