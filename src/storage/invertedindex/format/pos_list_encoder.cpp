...
void PositionListEncoder::Dump(const std::shared_ptr<FileWriter> &file) {
    Flush();
...
void PositionListEncoder::AddPosSkipListItem(uint32_t total_pos_count, uint32_t compressed_pos_size, bool need_flush) {
