...
void
SkipListWriter::AddItem(uint32_t key, uint32_t value1, uint32_t value2) {
...
void
SkipListWriter::AddItem(uint32_t key, uint32_t value1) {
    PushBack(0, key - last_key_);
    PushBack(1, value1);
    EndPushBack();
    last_key_ = key;
...
void
SkipListWriter::AddItem(uint32_t delta_value) {
