...
void ShortBuffer::BufferMemoryCopy(uint8_t *dst,
                                   uint8_t dst_col_count,
                                   uint8_t *src,
                                   uint8_t src_col_count,
                                   const PostingValues *posting_values,
                                   uint8_t src_size) {
...
bool ShortBuffer::SnapShot(ShortBuffer &short_buffer) const {
    ...
    do {
        ...
        BufferMemoryCopy((uint8_t *)short_buffer.buffer_,
                         short_buffer.capacity_,
                         (uint8_t *)buffer_snapshot,
                         snapshot_capacity,
                         posting_values_,
                         snapshot_size);
