...
public:
    ...
    Status Operate(const Vector<SharedPtr<MetaBaseCache>> &cache_items, KVInstance *kv_instance);

    // Status Erase(const Vector<SharedPtr<MetaBaseCache>> &cache_items, KVInstance *kv_instance);
