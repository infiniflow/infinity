...
//         auto rel_file_path = std::make_shared<std::string>(fmt::format("{}/{}", *block_dir_ptr, filename));
//         column_buffer_ = fileworker_mgr->GetFileWorker(*rel_file_path);
//         if (!column_buffer_) {
//             return Status::BufferManagerError(fmt::format("Get buffer object failed: {}", column_buffer_->GetFilePath()));
//         }
//     }
...
//         auto rel_file_path = std::make_shared<std::string>(fmt::format("{}/{}", *block_dir_ptr, filename));
//         outline_buffer_ = fileworker_mgr->GetFileWorker(*rel_file_path);
//         if (!outline_buffer_) {
//             return Status::BufferManagerError(fmt::format("Get buffer object failed: {}", *rel_file_path));
//         }
//     }
//     return Status::OK();
// }
