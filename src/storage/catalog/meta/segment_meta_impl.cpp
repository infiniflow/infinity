...
Tuple<SizeT, Status> SegmentMeta::GetRowCnt1() {
    ...
    LOG_INFO(fmt::format("SegmentMeta::GetRowCnt1 called: segment={}, begin_ts={}, commit_ts={}", segment_id_, begin_ts_, commit_ts_));
    ...
    LOG_INFO(fmt::format("SegmentMeta::GetRowCnt1 result: segment={}, row_count={}", segment_id_, *row_cnt_));
