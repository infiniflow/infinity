...
struct CreateConflict {
    enum type { Ignore = 0, Error = 1, Replace = 2 };
};
...
struct Constraint {
    enum type { PrimaryKey = 0, NotNull = 1, Null = 2, Unique = 3 };
};
...
struct KnnDistanceType {
    enum type { L2 = 0, Cosine = 1, InnerProduct = 2, Hamming = 3 };
};
...
struct CopyFileType {
    enum type { CSV = 0, JSON = 1, JSONL = 2, FVECS = 3, CSR = 4, BVECS = 5 };
};
...
struct ExplainType {
    enum type { Analyze = 0, Ast = 1, UnOpt = 2, Opt = 3, Physical = 4, Pipeline = 5, Fragment = 6 };
};
...
public:
    ...
    CreateOption() noexcept : conflict_type(static_cast<CreateConflict::type>(0)) {}
...
public:
    ...
    DropOption() noexcept : conflict_type(static_cast<DropConflict::type>(0)) {}
...
public:
    ...
    bool operator==(const NumberType & /* rhs */) const { return true; }
...
public:
    ...
    bool operator==(const VarcharType & /* rhs */) const { return true; }
...
public:
    ...
    EmbeddingType() noexcept : dimension(0), element_type(static_cast<ElementType::type>(0)) {}
...
public:
    ...
    SparseType() noexcept : dimension(0), element_type(static_cast<ElementType::type>(0)), index_type(static_cast<ElementType::type>(0)) {}
...
public:
    ...
    DataType() noexcept : logic_type(static_cast<LogicType::type>(0)) {}
...
public:
    ...
    ParsedExpr() noexcept : alias_name() {}
...
typedef struct _EmbeddingData__isset {
    _EmbeddingData__isset()
        : bool_array_value(false), u8_array_value(false), i8_array_value(false), i16_array_value(false), i32_array_value(false),
          i64_array_value(false), f32_array_value(false), f64_array_value(false), f16_array_value(false), bf16_array_value(false) {}
...
public:
    ...
    InitParameter() noexcept : param_name(), param_value() {}
...
public:
    ...
    ConstantExpr() noexcept : literal_type(static_cast<LiteralType::type>(0)), bool_value(0), i64_value(0), f64_value(0), str_value() {}
...
typedef struct _KnnExpr__isset {
    _KnnExpr__isset()
        : column_expr(false), embedding_data(false), embedding_data_type(false), distance_type(false), topn(false), opt_params(true),
          filter_expr(false) {}
    bool column_expr : 1;
...
public:
    ...
    KnnExpr() noexcept : embedding_data_type(static_cast<ElementType::type>(0)), distance_type(static_cast<KnnDistanceType::type>(0)), topn(0) {}
...
public:
    ...
    MatchSparseExpr() noexcept : metric_type(), topn(0) {}
...
typedef struct _MatchTensorExpr__isset {
    _MatchTensorExpr__isset()
        : search_method(false), column_expr(false), embedding_data_type(false), embedding_data(false), extra_options(false), filter_expr(false) {}
...
public:
    ...
    MatchTensorExpr() noexcept : search_method(), embedding_data_type(static_cast<ElementType::type>(0)), extra_options() {}
...
public:
    ...
    MatchExpr() noexcept : fields(), matching_text(), options_text() {}
...
public:
    ...
    GenericMatchExpr() noexcept : match_vector_expr(), match_sparse_expr(), match_tensor_expr(), match_text_expr() {}
...
public:
    ...
    FusionExpr() noexcept : method(), options_text() {}
...
public:
    ...
    FunctionExpr() noexcept : function_name() {}
...
public:
    ...
    UpdateExpr() noexcept : column_name() {}
...
public:
    ...
    ColumnDef() noexcept : id(0), name(), comment() {}
...
public:
    ...
    ColumnField() noexcept : column_type(static_cast<ColumnType::type>(0)), column_name() {}
...
public:
    ...
    ImportOption() noexcept : delimiter(), has_header(0), copy_file_type(static_cast<CopyFileType::type>(0)) {}
...
public:
    ...
    ExportOption() noexcept : delimiter(), has_header(0), copy_file_type(static_cast<CopyFileType::type>(0)), offset(0), limit(0), row_limit(0) {}
...
public:
    ...
    OptimizeOptions() noexcept : index_name() {}
    ...
    bool operator!=(const OptimizeOptions &rhs) const { return !(*this == rhs); }
...
public:
    ...
    ConnectRequest() noexcept : client_version(0) {}
...
public:
    ...
    CommonRequest() noexcept : session_id(0) {}
...
public:
    ...
    CommonResponse() noexcept : error_code(0), error_msg(), session_id(0) {}
...
public:
    ...
    ListDatabaseRequest() noexcept : session_id(0) {}
...
public:
    ...
    ListDatabaseResponse() noexcept : error_code(0), error_msg() {}
...
public:
    ...
    ListTableRequest() noexcept : db_name(), session_id(0) {}
...
public:
    ...
    ListTableResponse() noexcept : error_code(0), error_msg() {}
...
public:
    ...
    ListIndexRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    ListIndexResponse() noexcept : error_code(0), error_msg() {}
...
public:
    ...
    ShowDatabaseRequest() noexcept : db_name(), session_id(0) {}
...
typedef struct _ShowDatabaseResponse__isset {
    _ShowDatabaseResponse__isset()
        : error_code(false), error_msg(false), database_name(false), store_dir(false), table_count(false), comment(false) {}
    bool error_code : 1;
    bool error_msg : 1;
...
public:
    ...
    ShowDatabaseResponse() noexcept : error_code(0), error_msg(), database_name(), store_dir(), table_count(0), comment() {}
...
public:
    ...
    ShowTableRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
typedef struct _ShowTableResponse__isset {
    _ShowTableResponse__isset()
        : error_code(false), error_msg(false), database_name(false), table_name(false), store_dir(false), column_count(false), segment_count(false),
          row_count(false) {}
    bool error_code : 1;
    bool error_msg : 1;
    bool database_name : 1;
...
public:
    ...
    ShowColumnsRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    GetTableRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    IndexInfo() noexcept : column_name(), index_type(static_cast<IndexType::type>(0)) {}
...
typedef struct _CreateIndexRequest__isset {
    _CreateIndexRequest__isset()
        : db_name(false), table_name(false), index_name(false), index_comment(false), index_info(false), session_id(false), create_option(false) {}
    bool db_name : 1;
    bool table_name : 1;
    bool index_name : 1;
...
public:
    ...
    CreateIndexRequest() noexcept : db_name(), table_name(), index_name(), index_comment(), session_id(0) {}
...
public:
    ...
    DropIndexRequest() noexcept : db_name(), table_name(), index_name(), session_id(0) {}
...
public:
    ...
    ShowIndexRequest() noexcept : db_name(), table_name(), index_name(), session_id(0) {}
...
typedef struct _ShowIndexResponse__isset {
    _ShowIndexResponse__isset()
        : error_code(false), error_msg(false), db_name(false), table_name(false), index_name(false), index_comment(false), index_type(false),
          index_column_names(false), index_column_ids(false), other_parameters(false), store_dir(false), store_size(false),
...
public:
    ...
    ShowIndexResponse() noexcept
        : error_code(0), error_msg(), db_name(), table_name(), index_name(), index_comment(), index_type(), index_column_names(), index_column_ids(),
          other_parameters(), store_dir(), store_size(), segment_index_count() {}
...
public:
    ...
    OptimizeRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    GetDatabaseRequest() noexcept : db_name(), session_id(0) {}
...
public:
    ...
    CreateDatabaseRequest() noexcept : db_name(), session_id(0), db_comment() {}
...
public:
    ...
    DropDatabaseRequest() noexcept : db_name(), session_id(0) {}
...
public:
    ...
    CreateTableRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    DropTableRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    InsertRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    ImportRequest() noexcept : db_name(), table_name(), file_name(), session_id(0) {}
...
public:
    ...
    ExportRequest() noexcept : db_name(), table_name(), file_name(), session_id(0) {}
...
typedef struct _ExplainRequest__isset {
    _ExplainRequest__isset()
        : session_id(false), db_name(false), table_name(false), select_list(true), highlight_list(true), search_expr(false), where_expr(false),
          group_by_list(true), having_expr(false), limit_expr(false), offset_expr(false), order_by_list(true), explain_type(false) {}
    bool session_id : 1;
    bool db_name : 1;
    bool table_name : 1;
    bool select_list : 1;
...
public:
    ...
    ExplainRequest() noexcept : session_id(0), db_name(), table_name(), explain_type(static_cast<ExplainType::type>(0)) {}
...
public:
    ...
    ExplainResponse() noexcept : error_code(0), error_msg() {}
...
typedef struct _SelectRequest__isset {
    _SelectRequest__isset()
        : session_id(false), db_name(false), table_name(false), select_list(true), highlight_list(true), search_expr(false), where_expr(false),
          group_by_list(true), having_expr(false), limit_expr(false), offset_expr(false), order_by_list(true), total_hits_count(false) {}
    bool session_id : 1;
    bool db_name : 1;
    bool table_name : 1;
    bool select_list : 1;
...
public:
    ...
    SelectRequest() noexcept : session_id(0), db_name(), table_name(), total_hits_count(0) {}
...
public:
    ...
    SelectResponse() noexcept : error_code(0), error_msg(), extra_result() {}
...
public:
    ...
    DeleteRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    DeleteResponse() noexcept : error_code(0), error_msg(), deleted_rows(0) {}
...
public:
    ...
    UpdateRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    AddColumnsRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    DropColumnsRequest() noexcept : db_name(), table_name(), session_id(0) {}
...
public:
    ...
    ShowTablesRequest() noexcept : session_id(0), db_name() {}
    ...
    bool operator!=(const ShowTablesRequest &rhs) const { return !(*this == rhs); }
...
public:
    ...
    ShowSegmentsRequest() noexcept : session_id(0), db_name(), table_name() {}
...
public:
    ...
    ShowSegmentRequest() noexcept : session_id(0), db_name(), table_name(), segment_id(0) {}
...
typedef struct _ShowSegmentResponse__isset {
    _ShowSegmentResponse__isset()
        : error_code(false), error_msg(false), segment_id(false), status(false), path(false), size(false), block_count(false), row_capacity(false),
          row_count(false), room(false), column_count(false) {}
    bool error_code : 1;
    bool error_msg : 1;
    bool segment_id : 1;
    bool status : 1;
...
public:
    ...
    ShowSegmentResponse() noexcept
        : error_code(0), error_msg(), segment_id(0), status(), path(), size(), block_count(0), row_capacity(0), row_count(0), room(0),
          column_count(0) {}
...
public:
    ...
    ShowBlocksRequest() noexcept : session_id(0), db_name(), table_name(), segment_id(0) {}
...
public:
    ...
    ShowBlockRequest() noexcept : session_id(0), db_name(), table_name(), segment_id(0), block_id(0) {}
...
typedef struct _ShowBlockResponse__isset {
    _ShowBlockResponse__isset()
        : error_code(false), error_msg(false), block_id(false), path(false), size(false), row_capacity(false), row_count(false), column_count(false) {
    }
    bool error_code : 1;
    bool error_msg : 1;
    bool block_id : 1;
...
public:
    ...
    ShowBlockResponse() noexcept : error_code(0), error_msg(), block_id(0), path(), size(), row_capacity(0), row_count(0), column_count(0) {}
...
public:
    ...
    ShowBlockColumnRequest() noexcept : session_id(0), db_name(), table_name(), segment_id(0), block_id(0), column_id(0) {}
...
typedef struct _ShowBlockColumnResponse__isset {
    _ShowBlockColumnResponse__isset()
        : error_code(false), error_msg(false), column_name(false), column_id(false), data_type(false), path(false), extra_file_count(false),
          extra_file_names(false) {}
    bool error_code : 1;
    bool error_msg : 1;
    bool column_name : 1;
    bool column_id : 1;
...
public:
    ...
    ShowCurrentNodeRequest() noexcept : session_id(0) {}
...
public:
    ...
    ShowCurrentNodeResponse() noexcept : error_code(0), error_msg(), node_role(), server_status() {}
...
public:
    ...
    CommandRequest() noexcept : session_id(0), command_type(), test_command_content() {}
...
public:
    ...
    FlushRequest() noexcept : session_id(0), flush_type() {}
...
public:
    ...
    CompactRequest() noexcept : session_id(0), db_name(), table_name() {}
