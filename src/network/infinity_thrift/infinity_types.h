...
typedef struct _ShowIndexResponse__isset {
  _ShowIndexResponse__isset() : error_code(false), error_msg(false), db_name(false), table_name(false), index_name(false), index_comment(false), index_type(false), index_column_names(false), index_column_ids(false), other_parameters(false), store_dir(false), store_size(false), segment_index_count(false) {}
  bool error_code :1;
  bool error_msg :1;
  bool db_name :1;
  bool table_name :1;
