...
typedef struct _InitParameter__isset {
  _InitParameter__isset() : para_name(false), para_value(false) {}
  bool para_name :1;
  bool para_value :1;
...
class InitParameter : public virtual ::apache::thrift::TBase {
 public:
  ...
  void __set_para_name(const std::string& val);

  void __set_para_value(const std::string& val);

  bool operator == (const InitParameter & rhs) const
  {
    if (!(para_name == rhs.para_name))
      return false;
    if (!(para_value == rhs.para_value))
      return false;
    return true;
  }
  bool operator != (const InitParameter &rhs) const {
...
typedef struct _CreateIndexRequest__isset {
  _CreateIndexRequest__isset() : db_name(false), table_name(false), index_name(false), column_names(true), method_type(false), index_para_list(true), session_id(false), option(false) {}
  bool db_name :1;
  bool table_name :1;
  bool index_name :1;
  bool column_names :1;
  bool method_type :1;
  bool index_para_list :1;
  bool session_id :1;
  bool option :1;
...
class CreateIndexRequest : public virtual ::apache::thrift::TBase {
 public:
  ...
  std::vector<InitParameter>  index_para_list;
  int64_t session_id;
  Option option;
  ...
  void __set_method_type(const std::string& val);

  void __set_index_para_list(const std::vector<InitParameter> & val);
  ...
  bool operator == (const CreateIndexRequest & rhs) const
  {
    ...
    if (!(column_names == rhs.column_names))
      return false;
    if (!(method_type == rhs.method_type))
      return false;
    if (!(index_para_list == rhs.index_para_list))
      return false;
    if (!(session_id == rhs.session_id))
      return false;
