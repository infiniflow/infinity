...
typedef struct _ParsedExprType__isset {
  _ParsedExprType__isset() : constant_expr(false), column_expr(false), function_expr(false), between_expr(false), knn_expr(false), match_sparse_expr(false), match_tensor_expr(false), match_expr(false), fusion_expr(false), search_expr(false), in_expr(false), cast_expr(false) {}
...
typedef struct _AlterIndexOptions__isset {
  _AlterIndexOptions__isset() : index_name(false), opt_params(true) {}
  bool index_name :1;
  bool opt_params :1;
} _AlterIndexOptions__isset;

class AlterIndexOptions : public virtual ::apache::thrift::TBase {
 public:

  AlterIndexOptions(const AlterIndexOptions&);
  AlterIndexOptions& operator=(const AlterIndexOptions&);
  AlterIndexOptions() noexcept;

  virtual ~AlterIndexOptions() noexcept;
  std::string index_name;
  std::vector<InitParameter>  opt_params;

  _AlterIndexOptions__isset __isset;
...
typedef struct _ShowIndexResponse__isset {
  _ShowIndexResponse__isset() : error_code(false), error_msg(false), db_name(false), table_name(false), index_name(false), index_comment(false), index_type(false), index_column_names(false), index_column_ids(false), index_function_info(false), other_parameters(false), store_dir(false), segment_index_count(false) {}
  bool error_code :1;
  bool error_msg :1;
  bool db_name :1;
  bool table_name :1;
...
typedef struct _OptimizeRequest__isset {
  _OptimizeRequest__isset() : db_name(false), table_name(false), session_id(false) {}
  bool db_name :1;
  bool table_name :1;
  bool session_id :1;
...
typedef struct _AlterIndexRequest__isset {
  _AlterIndexRequest__isset() : db_name(false), table_name(false), alter_index_options(false), session_id(false) {}
  bool db_name :1;
  bool table_name :1;
  bool alter_index_options :1;
  bool session_id :1;
} _AlterIndexRequest__isset;

class AlterIndexRequest : public virtual ::apache::thrift::TBase {
 public:

  AlterIndexRequest(const AlterIndexRequest&);
  AlterIndexRequest& operator=(const AlterIndexRequest&);
  AlterIndexRequest() noexcept;

  virtual ~AlterIndexRequest() noexcept;
  std::string db_name;
  std::string table_name;
  AlterIndexOptions alter_index_options;
  int64_t session_id;

  _AlterIndexRequest__isset __isset;

  void __set_db_name(const std::string& val);

  void __set_table_name(const std::string& val);

  void __set_alter_index_options(const AlterIndexOptions& val);
...
typedef struct _RenameTableRequest__isset {
  _RenameTableRequest__isset() : db_name(false), table_name(false), new_table_name(false), session_id(false) {}
  bool db_name :1;
  bool table_name :1;
  bool new_table_name :1;
  bool session_id :1;
} _RenameTableRequest__isset;

class RenameTableRequest : public virtual ::apache::thrift::TBase {
 public:

  RenameTableRequest(const RenameTableRequest&);
  RenameTableRequest& operator=(const RenameTableRequest&);
  RenameTableRequest() noexcept;

  virtual ~RenameTableRequest() noexcept;
  std::string db_name;
  std::string table_name;
  std::string new_table_name;
  int64_t session_id;

  _RenameTableRequest__isset __isset;

  void __set_db_name(const std::string& val);

  void __set_table_name(const std::string& val);

  void __set_new_table_name(const std::string& val);
