...
const std::map<int, const char*> _LogicType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(25, _kLogicTypeValues, _kLogicTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _ColumnType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(24, _kColumnTypeValues, _kColumnTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
const std::map<int, const char*> _IndexType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(10, _kIndexTypeValues, _kIndexTypeNames), ::apache::thrift::TEnumIterator(-1, nullptr, nullptr));
...
void swap(Property &a, Property &b) noexcept {
  using ::std::swap;
  swap(a.key, b.key);
...
void swap(CreateOption &a, CreateOption &b) noexcept {
  using ::std::swap;
...
void swap(DropOption &a, DropOption &b) noexcept {
  using ::std::swap;
  swap(a.conflict_type, b.conflict_type);
  swap(a.__isset, b.__isset);
}
...
void swap(NumberType &a, NumberType &b) noexcept {
  using ::std::swap;
  (void) a;
  (void) b;
}
...
void swap(VarcharType &a, VarcharType &b) noexcept {
  using ::std::swap;
  (void) a;
  (void) b;
}
...
void swap(EmbeddingType &a, EmbeddingType &b) noexcept {
  using ::std::swap;
...
void swap(SparseType &a, SparseType &b) noexcept {
  using ::std::swap;
  swap(a.dimension, b.dimension);
  swap(a.element_type, b.element_type);
...
void swap(ArrayType &a, ArrayType &b) noexcept {
  using ::std::swap;
...
void swap(PhysicalType &a, PhysicalType &b) noexcept {
  using ::std::swap;
...
void swap(DataType &a, DataType &b) noexcept {
  using ::std::swap;
    ...
    switch (fid)
    {
      ...
      case 12:
        if (ftype == ::apache::thrift::protocol::T_STRUCT) {
          ...
          bool wasSet = false;
          if (this->cast_expr->__isset.expr) { wasSet = true; }
          if (this->cast_expr->__isset.data_type) { wasSet = true; }
          if (!wasSet) { this->cast_expr.reset(); }
...
uint32_t ParsedExprType::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.cast_expr) {
    ...
    } else {oprot->writeStructBegin("CastExpr"); 
      oprot->writeStructEnd();
      oprot->writeFieldStop();
    }
    xfer += oprot->writeFieldEnd();
...
void swap(ParsedExprType &a, ParsedExprType &b) noexcept {
  using ::std::swap;
...
bool ParsedExprType::operator==(const ParsedExprType & rhs) const
{
  ...
  if (__isset.in_expr != rhs.__isset.in_expr)
    ...
    return false;
  if (__isset.cast_expr != rhs.__isset.cast_expr)
    return false;
  else if (__isset.cast_expr && !(cast_expr == rhs.cast_expr))
    return false;
  return true;
}
...
void swap(ParsedExpr &a, ParsedExpr &b) noexcept {
  using ::std::swap;
  swap(a.type, b.type);
...
void swap(ColumnExpr &a, ColumnExpr &b) noexcept {
  using ::std::swap;
...
void swap(EmbeddingData &a, EmbeddingData &b) noexcept {
  using ::std::swap;
...
void swap(InitParameter &a, InitParameter &b) noexcept {
  using ::std::swap;
...
void swap(ConstantExpr &a, ConstantExpr &b) noexcept {
  using ::std::swap;
...
void swap(FunctionExpr &a, FunctionExpr &b) noexcept {
  using ::std::swap;
...
void swap(KnnExpr &a, KnnExpr &b) noexcept {
  using ::std::swap;
  swap(a.column_expr, b.column_expr);
...
void swap(MatchSparseExpr &a, MatchSparseExpr &b) noexcept {
  using ::std::swap;
  swap(a.column_expr, b.column_expr);
...
void swap(MatchTensorExpr &a, MatchTensorExpr &b) noexcept {
  using ::std::swap;
...
void swap(MatchExpr &a, MatchExpr &b) noexcept {
  using ::std::swap;
...
void swap(GenericMatchExpr &a, GenericMatchExpr &b) noexcept {
  using ::std::swap;
...
void swap(FusionExpr &a, FusionExpr &b) noexcept {
  using ::std::swap;
...
void swap(SearchExpr &a, SearchExpr &b) noexcept {
  using ::std::swap;
...
void swap(BetweenExpr &a, BetweenExpr &b) noexcept {
  using ::std::swap;
  swap(a.value, b.value);
...
void swap(UpdateExpr &a, UpdateExpr &b) noexcept {
  using ::std::swap;
  swap(a.column_name, b.column_name);
  swap(a.value, b.value);
  swap(a.__isset, b.__isset);
...
void swap(OrderByExpr &a, OrderByExpr &b) noexcept {
  using ::std::swap;
  swap(a.expr, b.expr);
  swap(a.asc, b.asc);
  swap(a.__isset, b.__isset);
...
void swap(InExpr &a, InExpr &b) noexcept {
  using ::std::swap;
...
void CastExpr::__set_expr(const ParsedExpr& val) {
  this->expr = val;
}

void CastExpr::__set_data_type(const DataType& val) {
  this->data_type = val;
}
...
void swap(CastExpr &a, CastExpr &b) noexcept {
  using ::std::swap;
  swap(a.expr, b.expr);
...
bool CastExpr::operator==(const CastExpr & rhs) const
{
  if (!(expr == rhs.expr))
    return false;
...
void swap(ColumnDef &a, ColumnDef &b) noexcept {
  using ::std::swap;
  swap(a.id, b.id);
  swap(a.name, b.name);
  swap(a.data_type, b.data_type);
...
void swap(Field &a, Field &b) noexcept {
  using ::std::swap;
...
void ColumnField::__set_bitmasks(const std::vector<bool> & val) {
  this->bitmasks = val;
}
...
void swap(ColumnField &a, ColumnField &b) noexcept {
  using ::std::swap;
...
void swap(ImportOption &a, ImportOption &b) noexcept {
  using ::std::swap;
...
void swap(ExportOption &a, ExportOption &b) noexcept {
  using ::std::swap;
  swap(a.delimiter, b.delimiter);
  swap(a.has_header, b.has_header);
  swap(a.copy_file_type, b.copy_file_type);
...
void AlterIndexOptions::__set_index_name(const std::string& val) {
  this->index_name = val;
}

void AlterIndexOptions::__set_opt_params(const std::vector<InitParameter> & val) {
  this->opt_params = val;
}
...
void swap(AlterIndexOptions &a, AlterIndexOptions &b) noexcept {
  using ::std::swap;
...
void swap(ConnectRequest &a, ConnectRequest &b) noexcept {
  using ::std::swap;
...
void swap(CommonRequest &a, CommonRequest &b) noexcept {
  using ::std::swap;
...
void swap(CommonResponse &a, CommonResponse &b) noexcept {
  using ::std::swap;
...
void swap(ListDatabaseRequest &a, ListDatabaseRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.__isset, b.__isset);
}
...
void swap(ListDatabaseResponse &a, ListDatabaseResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
...
void swap(ListTableRequest &a, ListTableRequest &b) noexcept {
  using ::std::swap;
...
void swap(ListTableResponse &a, ListTableResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
...
void swap(ListIndexRequest &a, ListIndexRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
...
void swap(ListIndexResponse &a, ListIndexResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
...
void swap(ShowDatabaseRequest &a, ShowDatabaseRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.session_id, b.session_id);
  swap(a.__isset, b.__isset);
...
void swap(ShowDatabaseResponse &a, ShowDatabaseResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
...
void swap(ShowTableRequest &a, ShowTableRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.session_id, b.session_id);
...
void swap(ShowTableResponse &a, ShowTableResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.database_name, b.database_name);
...
void swap(ShowColumnsRequest &a, ShowColumnsRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.session_id, b.session_id);
...
void IndexInfo::__set_function_expr(const FunctionExpr& val) {
  this->function_expr = val;
}
...
void swap(IndexInfo &a, IndexInfo &b) noexcept {
  using ::std::swap;
  swap(a.column_name, b.column_name);
  swap(a.index_type, b.index_type);
...
void swap(CreateIndexRequest &a, CreateIndexRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.index_name, b.index_name);
...
void swap(DropIndexRequest &a, DropIndexRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.index_name, b.index_name);
...
void swap(ShowIndexRequest &a, ShowIndexRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.index_name, b.index_name);
...
void ShowIndexResponse::__set_index_function_info(const std::string& val) {
  this->index_function_info = val;
}
...
void swap(ShowIndexResponse &a, ShowIndexResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.db_name, b.db_name);
...
void swap(OptimizeRequest &a, OptimizeRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.session_id, b.session_id);
...
void AlterIndexRequest::__set_db_name(const std::string& val) {
  this->db_name = val;
}

void AlterIndexRequest::__set_table_name(const std::string& val) {
  this->table_name = val;
}

void AlterIndexRequest::__set_alter_index_options(const AlterIndexOptions& val) {
  this->alter_index_options = val;
}

void AlterIndexRequest::__set_session_id(const int64_t val) {
  this->session_id = val;
}
...
void swap(AlterIndexRequest &a, AlterIndexRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(RenameTableRequest &a, RenameTableRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(InsertRequest &a, InsertRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.fields, b.fields);
...
void swap(ImportRequest &a, ImportRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(ExportRequest &a, ExportRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(ExplainRequest &a, ExplainRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(ExplainResponse &a, ExplainResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.column_defs, b.column_defs);
...
void swap(SelectRequest &a, SelectRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(SelectResponse &a, SelectResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.column_defs, b.column_defs);
...
void swap(DeleteRequest &a, DeleteRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.where_expr, b.where_expr);
...
void swap(DeleteResponse &a, DeleteResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
...
void swap(UpdateRequest &a, UpdateRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.where_expr, b.where_expr);
...
void swap(AddColumnsRequest &a, AddColumnsRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.column_defs, b.column_defs);
...
void swap(DropColumnsRequest &a, DropColumnsRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.column_names, b.column_names);
...
void swap(DumpIndexRequest &a, DumpIndexRequest &b) noexcept {
  using ::std::swap;
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
  swap(a.index_name, b.index_name);
...
void swap(ShowSegmentsRequest &a, ShowSegmentsRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(ShowSegmentRequest &a, ShowSegmentRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(ShowSegmentResponse &a, ShowSegmentResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.segment_id, b.segment_id);
...
void swap(ShowBlocksRequest &a, ShowBlocksRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(ShowBlockRequest &a, ShowBlockRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(ShowBlockResponse &a, ShowBlockResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.block_id, b.block_id);
...
void swap(ShowBlockColumnRequest &a, ShowBlockColumnRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(ShowBlockColumnResponse &a, ShowBlockColumnResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.column_name, b.column_name);
...
void swap(ShowCurrentNodeRequest &a, ShowCurrentNodeRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.__isset, b.__isset);
}
...
void swap(ShowCurrentNodeResponse &a, ShowCurrentNodeResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
...
void swap(CommandRequest &a, CommandRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
...
void swap(FlushRequest &a, FlushRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
...
void swap(CompactRequest &a, CompactRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(CreateTableSnapshotRequest &a, CreateTableSnapshotRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.table_name, b.table_name);
...
void swap(CreateDatabaseSnapshotRequest &a, CreateDatabaseSnapshotRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.db_name, b.db_name);
  swap(a.snapshot_name, b.snapshot_name);
...
void swap(CreateSystemSnapshotRequest &a, CreateSystemSnapshotRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.snapshot_name, b.snapshot_name);
  swap(a.__isset, b.__isset);
...
void swap(RestoreSnapshotRequest &a, RestoreSnapshotRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.snapshot_name, b.snapshot_name);
...
void swap(SnapshotInfo &a, SnapshotInfo &b) noexcept {
  using ::std::swap;
  swap(a.name, b.name);
  swap(a.scope, b.scope);
  swap(a.time, b.time);
...
void swap(ShowSnapshotRequest &a, ShowSnapshotRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.snapshot_name, b.snapshot_name);
  swap(a.__isset, b.__isset);
...
void swap(ShowSnapshotResponse &a, ShowSnapshotResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
...
void swap(ListSnapshotsRequest &a, ListSnapshotsRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.__isset, b.__isset);
}
...
void swap(ListSnapshotsResponse &a, ListSnapshotsResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
...
void swap(DropSnapshotRequest &a, DropSnapshotRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.snapshot_name, b.snapshot_name);
  swap(a.__isset, b.__isset);
...
void swap(ConfigValue &a, ConfigValue &b) noexcept {
  using ::std::swap;
...
void swap(SetConfigRequest &a, SetConfigRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
...
void swap(ShowConfigRequest &a, ShowConfigRequest &b) noexcept {
  using ::std::swap;
  swap(a.session_id, b.session_id);
  swap(a.config_name, b.config_name);
  swap(a.__isset, b.__isset);
...
void swap(ShowConfigResponse &a, ShowConfigResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.config_name, b.config_name);
