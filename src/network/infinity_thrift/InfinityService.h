...
class InfinityServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_AlterIndex(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
  ...
  void process_ShowConfig(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
