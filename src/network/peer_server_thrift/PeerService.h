...
public:
    ...
    virtual PeerServiceIf *getHandler(const ::apache::thrift::TConnectionInfo &) override { return iface_.get(); }
...
public:
    ...
    void Register(RegisterResponse & /* _return */, const RegisterRequest & /* request */) override { return; }
    void Unregister(UnregisterResponse & /* _return */, const UnregisterRequest & /* request */) override { return; }
    void HeartBeat(HeartBeatResponse & /* _return */, const HeartBeatRequest & /* request */) override { return; }
    void SyncLog(SyncLogResponse & /* _return */, const SyncLogRequest & /* request */) override { return; }
    void ChangeRole(ChangeRoleResponse & /* _return */, const ChangeRoleRequest & /* request */) override { return; }
    void NewLeader(NewLeaderResponse & /* _return */, const NewLeaderRequest & /* request */) override { return; }
};
...
public:
    ...
    bool operator!=(const PeerService_Register_args &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_Register_result &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_Unregister_args &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_Unregister_result &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_HeartBeat_args &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_HeartBeat_result &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_SyncLog_args &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_SyncLog_result &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_ChangeRole_args &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_ChangeRole_result &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_NewLeader_args &rhs) const { return !(*this == rhs); }
...
public:
    ...
    bool operator!=(const PeerService_NewLeader_result &rhs) const { return !(*this == rhs); }
...
public:
    PeerServiceClient(std::shared_ptr<::apache::thrift::protocol::TProtocol> prot) { setProtocol(prot); }
...
private:
    typedef void (PeerServiceProcessor::*ProcessFunction)(int32_t,
    ...
    void
    process_Register(int32_t seqid, ::apache::thrift::protocol::TProtocol *iprot, ::apache::thrift::protocol::TProtocol *oprot, void *callContext);
    void
    process_Unregister(int32_t seqid, ::apache::thrift::protocol::TProtocol *iprot, ::apache::thrift::protocol::TProtocol *oprot, void *callContext);
    void
    process_HeartBeat(int32_t seqid, ::apache::thrift::protocol::TProtocol *iprot, ::apache::thrift::protocol::TProtocol *oprot, void *callContext);
    void
    process_SyncLog(int32_t seqid, ::apache::thrift::protocol::TProtocol *iprot, ::apache::thrift::protocol::TProtocol *oprot, void *callContext);
    void
    process_ChangeRole(int32_t seqid, ::apache::thrift::protocol::TProtocol *iprot, ::apache::thrift::protocol::TProtocol *oprot, void *callContext);
    void
    process_NewLeader(int32_t seqid, ::apache::thrift::protocol::TProtocol *iprot, ::apache::thrift::protocol::TProtocol *oprot, void *callContext);

public:
    PeerServiceProcessor(::std::shared_ptr<PeerServiceIf> iface) : iface_(iface) {
...
public:
    PeerServiceProcessorFactory(const ::std::shared_ptr<PeerServiceIfFactory> &handlerFactory) noexcept : handlerFactory_(handlerFactory) {}
...
protected:
    ...
    void add(::std::shared_ptr<PeerServiceIf> iface) { ifaces_.push_back(iface); }
...
public:
    PeerServiceConcurrentClient(std::shared_ptr<::apache::thrift::protocol::TProtocol> prot,
                                std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync)
        : sync_(sync) {
        setProtocol(prot);
    }
    PeerServiceConcurrentClient(std::shared_ptr<::apache::thrift::protocol::TProtocol> iprot,
