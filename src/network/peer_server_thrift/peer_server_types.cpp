...
void swap(NodeInfo &a, NodeInfo &b) noexcept {
  using ::std::swap;
...
void swap(RegisterRequest &a, RegisterRequest &b) noexcept {
  using ::std::swap;
  swap(a.node_name, b.node_name);
  swap(a.node_type, b.node_type);
  swap(a.node_ip, b.node_ip);
...
void swap(RegisterResponse &a, RegisterResponse &b) noexcept {
  using ::std::swap;
...
void swap(UnregisterRequest &a, UnregisterRequest &b) noexcept {
  using ::std::swap;
  swap(a.node_name, b.node_name);
  swap(a.__isset, b.__isset);
}
...
void swap(UnregisterResponse &a, UnregisterResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.__isset, b.__isset);
...
void swap(HeartBeatResponse &a, HeartBeatResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.leader_term, b.leader_term);
...
void swap(SyncLogRequest &a, SyncLogRequest &b) noexcept {
  using ::std::swap;
  swap(a.node_name, b.node_name);
...
void swap(SyncLogResponse &a, SyncLogResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.txn_timestamp, b.txn_timestamp);
...
void swap(ChangeRoleRequest &a, ChangeRoleRequest &b) noexcept {
  using ::std::swap;
  swap(a.node_name, b.node_name);
  swap(a.node_type, b.node_type);
  swap(a.__isset, b.__isset);
...
void swap(ChangeRoleResponse &a, ChangeRoleResponse &b) noexcept {
  using ::std::swap;
  swap(a.error_code, b.error_code);
  swap(a.error_msg, b.error_msg);
  swap(a.__isset, b.__isset);
...
void swap(NewLeaderRequest &a, NewLeaderRequest &b) noexcept {
  using ::std::swap;
  swap(a.node_name, b.node_name);
  swap(a.node_ip, b.node_ip);
  swap(a.node_port, b.node_port);
...
void swap(NewLeaderResponse &a, NewLeaderResponse &b) noexcept {
  using ::std::swap;
  swap(a.node_name, b.node_name);
  swap(a.__isset, b.__isset);
}
