...
CachedMatchScanBase::CachedMatchScanBase(TxnTimeStamp query_ts, const LogicalMatchScanBase *logical_match_scan)
    : CachedMatchBase(logical_match_scan->operator_type(),
                      logical_match_scan->base_table_ref_->schema_name(),
                      logical_match_scan->base_table_ref_->table_name(),
                      logical_match_scan->base_table_ref_->column_ids_,
                      query_ts,
                      logical_match_scan->GetOutputNames()),
...
CachedMatchScanBase::CachedMatchScanBase(TxnTimeStamp query_ts, const PhysicalKnnScan *physical_knn_scan)
    : CachedMatchBase(LogicalNodeType::kKnnScan,
                      physical_knn_scan->base_table_ref_->schema_name(),
                      physical_knn_scan->base_table_ref_->table_name(),
                      physical_knn_scan->base_table_ref_->column_ids_,
                      query_ts,
                      physical_knn_scan->GetOutputNames()),
      query_expression_(physical_knn_scan->knn_expression_), filter_expression_(physical_knn_scan->common_query_filter_->original_filter_) {}

CachedMatchScanBase::CachedMatchScanBase(TxnTimeStamp query_ts, const PhysicalMatchSparseScan *physical_sparse_scan)
    : CachedMatchBase(LogicalNodeType::kMatchSparseScan,
                      physical_sparse_scan->base_table_ref_->schema_name(),
                      physical_sparse_scan->base_table_ref_->table_name(),
                      physical_sparse_scan->base_table_ref_->column_ids_,
                      query_ts,
                      physical_sparse_scan->GetOutputNames()),
      query_expression_(physical_sparse_scan->match_sparse_expr()), filter_expression_(physical_sparse_scan->common_query_filter_->original_filter_) {
}

CachedMatchScanBase::CachedMatchScanBase(TxnTimeStamp query_ts, const PhysicalMatchTensorScan *physical_tensor_scan)
    : CachedMatchBase(LogicalNodeType::kMatchTensorScan,
                      physical_tensor_scan->base_table_ref_->schema_name(),
                      physical_tensor_scan->base_table_ref_->table_name(),
                      physical_tensor_scan->base_table_ref_->column_ids_,
                      query_ts,
                      physical_tensor_scan->GetOutputNames()),
      query_expression_(physical_tensor_scan->match_tensor_expr()),
