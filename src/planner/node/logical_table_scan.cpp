...
LogicalTableScan::LogicalTableScan(int64_t table_index, int64_t node_id, std::shared_ptr<Table> table_ptr)
    : LogicalNode(LogicalNodeType::kTableScan),
    table_index_(table_index), node_id_(node_id), table_ptr_(std::move(table_ptr)) {
