...
public:
    LogicalDropTable(u64 node_id, std::shared_ptr<std::string> schema_name, std::shared_ptr<std::string> table_name, ConflictType conflict_type)
    ...
    inline std::string name() final { return "LogicalDropTable"; }

    [[nodiscard]] inline std::shared_ptr<std::string> table_name() const { return table_name_; }
