...
auto main(int argc, char **argv) -> int {
    ...
    std::cout << "Infinity, version: " << VERSION_MAJOR << "." << VERSION_MINOR << "." << VERSION_PATCH << " built on " << BUILD_TIME << " with "
              << BUILD_TYPE << " mode from branch: " << GIT_BRANCH_NAME << ", commit-id: " << GIT_COMMIT_ID << std::endl;
