export module infinity_core:byte_slice;
...
export struct ByteSlice {
    ...
    static ByteSlice *CreateSlice(size_t data_size);

    static ByteSlice *NewSlice(u8 *data, size_t data_size);
    ...
    size_t volatile size_ = 0;
    size_t volatile offset_ = 0;
