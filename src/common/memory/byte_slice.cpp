...
ByteSliceListIterator::ByteSliceListIterator(const ByteSliceListIterator& other)
    : slice_list_(other.slice_list_), slice_(other.slice_), pos_in_slice_(other.pos_in_slice_), seeked_slice_size_(other.seeked_slice_size_), end_pos_(other.end_pos_) {
}

bool
ByteSliceListIterator::SeekSlice(size_t begin_pos) {
...
bool
ByteSliceListIterator::HasNext(size_t end_pos) {
...
void
ByteSliceListIterator::Next(void*& data, size_t& size) {
    size_t cur_pos = seeked_slice_size_ + pos_in_slice_;
    size_t slice_end_pos = seeked_slice_size_ + slice_->size_;
