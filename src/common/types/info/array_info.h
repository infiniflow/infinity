...
public:
    static SharedPtr<ArrayInfo> Make(DataType elem_type) { return MakeShared<ArrayInfo>(std::move(elem_type)); }
    ...
    [[nodiscard]] inline String ToString() const override { return "array(" + elem_type_.ToString() + ")"; }
