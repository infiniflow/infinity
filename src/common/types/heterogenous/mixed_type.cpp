...
MixedType MixedType::MakeInteger(i64 input) {
...
MixedType MixedType::MakeFloat(f64 input) {
...
MixedType MixedType::MakeString(const String &str) {
...
MixedType MixedType::MakeTuple(u16 count) {
...
MixedType MixedType::MakeArray(u16 count) {
...
void MixedType::CopyIntoTuple(const String &key, const MixedType &value) {
...
void MixedType::MoveIntoTuple(const String &key, MixedType &&value) {
    TypeAssert(this->type == MixedValueType::kTuple, "Not tuple type, can't set value.");
    auto *tuple_ptr = (TupleMixedType *)(this);
    TypeAssert(tuple_ptr->count > 0, "The tuple isn't initialized");
...
MixedType *MixedType::GetFromTuple(const String &key) const {
...
void MixedType::CheckKeyConflict(MixedType &key_ref, const String &key_str) {
    switch (key_ref.type) {
        case MixedValueType::kShortStr: {
            auto *key_ptr = (ShortStrMixedType *)(&key_ref);
...
void MixedType::InsertIntegerIntoTuple(const String &key, i64 value) {
    TypeAssert(this->type == MixedValueType::kTuple, "Not tuple type, can't set value.");
    auto *tuple_ptr = (TupleMixedType *)(this);
    TypeAssert(tuple_ptr->count > 0, "The tuple isn't initialized");
...
void MixedType::InsertFloatIntoTuple(const String &key, f64 value) {
    TypeAssert(this->type == MixedValueType::kTuple, "Not tuple type, can't set value.");
    auto *tuple_ptr = (TupleMixedType *)(this);
    TypeAssert(tuple_ptr->count > 0, "The tuple isn't initialized");
...
void MixedType::InsertStringIntoTuple(const String &key, const String &value) {
    TypeAssert(this->type == MixedValueType::kTuple, "Not tuple type, can't set value.");
    auto *tuple_ptr = (TupleMixedType *)(this);
    TypeAssert(tuple_ptr->count > 0, "The tuple isn't initialized");
...
void MixedType::InsertNullIntoTuple(const String &key) {
    TypeAssert(this->type == MixedValueType::kTuple, "Not tuple type, can't set value.");
    auto *tuple_ptr = (TupleMixedType *)(this);
    TypeAssert(tuple_ptr->count > 0, "The tuple isn't initialized");
...
void MixedType::CopyIntoArray(const MixedType &value, u16 index) {
...
void MixedType::MoveIntoArray(MixedType &&value, u16 index) {
...
void MixedType::InsertIntegerIntoArray(i64 value, u16 index) {
    auto *array_mixed_ptr = (ArrayMixedType *)this;
    TypeAssert(index < array_mixed_ptr->count, "Index is invalid");
...
void MixedType::InsertFloatIntoArray(f64 value, u16 index) {
    auto *array_mixed_ptr = (ArrayMixedType *)this;
    TypeAssert(index < array_mixed_ptr->count, "Index is invalid");
...
void MixedType::InsertStringIntoArray(const String &value, u16 index) {
    auto *array_mixed_ptr = (ArrayMixedType *)this;
    TypeAssert(index < array_mixed_ptr->count, "Index is invalid");
...
void MixedType::InsertNullIntoArray(u16 index) {
    auto *array_mixed_ptr = (ArrayMixedType *)this;
    TypeAssert(index < array_mixed_ptr->count, "Index is invalid");
...
MixedType *MixedType::GetByIndex(u16 index) const {
    auto *array_mixed_ptr = (ArrayMixedType *)this;
    TypeAssert(index < array_mixed_ptr->count, "Index is invalid");
    auto *array_value_ptr = (MixedArrayValue *)(array_mixed_ptr->ptr);
...
bool MixedType::operator==(const MixedType &other) const {
    ...
    switch (this->type) {
        case MixedValueType::kInvalid:
        TypeError("Invalid heterogeneous type") case MixedValueType::kInteger: {
