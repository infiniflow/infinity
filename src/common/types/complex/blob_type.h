...
public:
    ...
    inline BlobType(ptr_t blob_ptr, u64 blob_size) : ptr(blob_ptr), size(blob_size) {}
...
public:
    void Copy(ptr_t blob_ptr, u64 blob_size);

    void Move(ptr_t blob_ptr, u64 blob_size);
    ...
    [[nodiscard]] inline String ToString() const { return {this->ptr, this->size}; }
};
