...
export {
    ...
    constexpr size_t BG_GROUND_TASK_QUEUE_SIZE = 65536;
    constexpr size_t EXECUTOR_TASK_QUEUE_SIZE = 1024;
    constexpr size_t DEFAULT_BLOCKING_QUEUE_SIZE = 1024;
    ...
    constexpr size_t DEFAULT_RANDOM_NAME_LEN = 10;

    constexpr size_t DEFAULT_BASE_NUM = 2;
    constexpr size_t DEFAULT_BASE_FILE_SIZE = 8 * 1024;
    constexpr size_t DEFAULT_OUTLINE_FILE_MAX_SIZE = 16 * 1024 * 1024;

    constexpr size_t DEFAULT_CHUNK_SIZE = 10 * 1024 * 1024;
    constexpr size_t DEFAULT_ALIGN_SIZE = sizeof(char *);
    ...
    constexpr size_t MAX_MEMINDEX_CAPACITY = DEFAULT_SEGMENT_CAPACITY;       // 1 Segment
    ...
    constexpr size_t DISTANCE_COMPUTE_BLAS_QUERY_BS = 4096;
    constexpr size_t DISTANCE_COMPUTE_BLAS_DATABASE_BS = 1024;

    constexpr size_t DBT_COMPACTION_M = 4;
    constexpr size_t DBT_COMPACTION_C = 4;
    constexpr size_t DBT_COMPACTION_S = DEFAULT_BLOCK_CAPACITY;
    ...
    constexpr size_t DEFAULT_BUFFER_MANAGER_SIZE = 2 * 1024lu * 1024lu * 1024lu; // 8Gib
    constexpr size_t DEFAULT_BUFFER_MANAGER_LRU_COUNT = 7;
    constexpr std::string_view DEFAULT_BUFFER_MANAGER_SIZE_STR = "2GB"; // 8Gib
    ...
    constexpr size_t DEFAULT_CACHE_RESULT_CAPACITY = 10000;
    ...
    // network
    constexpr size_t DEFAULT_HTTP_PORT = 23820;
    constexpr size_t DEFAULT_PEER_PORT = 23850;
    constexpr size_t DEFAULT_POSTGRES_PORT = 5432;
    constexpr size_t DEFAULT_CLIENT_PORT = 23817;

    constexpr size_t DEFAULT_PEER_RETRY_DELAY = 1000; // 1 second
    constexpr size_t DEFAULT_PEER_RETRY_COUNT = 2;
    constexpr size_t DEFAULT_PEER_CONNECT_TIMEOUT = 2000; // 2 seconds
    constexpr size_t DEFAULT_PEER_RECV_TIMEOUT = 0;       // not set
    constexpr size_t DEFAULT_PEER_SEND_TIMEOUT = 0;       // not set
