...
export std::vector<std::shared_ptr<BaseExpression>> SplitExpressionByDelimiter(const std::shared_ptr<BaseExpression> &expression,
...
export void VisitExpression(const std::shared_ptr<BaseExpression> &expression,
