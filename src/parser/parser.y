...
%token ADMIN LEADER FOLLOWER LEARNER CONNECT STANDALONE NODES NODE REMOVE SNAPSHOT SNAPSHOTS RECOVER RESTORE CACHES
...
| SHOW CACHES {
     $$ = new infinity::ShowStatement();
     $$->show_type_ = infinity::ShowStmtType::kListCaches;
}
