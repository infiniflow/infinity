...
enum sqltokentype {
    ...
    JSON_EXTRACT_STRING = 408, /* JSON_EXTRACT_STRING  */
    JSON_EXTRACT_INT = 409,    /* JSON_EXTRACT_INT  */
    EQUAL = 410,               /* EQUAL  */
    NOT_EQ = 411,              /* NOT_EQ  */
    LESS_EQ = 412,             /* LESS_EQ  */
    GREATER_EQ = 413,          /* GREATER_EQ  */
    BETWEEN = 414,             /* BETWEEN  */
    AND = 415,                 /* AND  */
    OR = 416,                  /* OR  */
    EXTRACT = 417,             /* EXTRACT  */
    ...
    LOG = 420,                 /* LOG  */
    BUFFER = 421,              /* BUFFER  */
    TRANSACTIONS = 422,        /* TRANSACTIONS  */
    TRANSACTION = 423,         /* TRANSACTION  */
    MEMINDEX = 424,            /* MEMINDEX  */
    USING = 425,               /* USING  */
    SESSION = 426,             /* SESSION  */
    GLOBAL = 427,              /* GLOBAL  */
    OFF = 428,                 /* OFF  */
    ...
    CONFIGS = 430,             /* CONFIGS  */
    CONFIG = 431,              /* CONFIG  */
    PROFILES = 432,            /* PROFILES  */
    VARIABLES = 433,           /* VARIABLES  */
    VARIABLE = 434,            /* VARIABLE  */
    LOGS = 435,                /* LOGS  */
    ...
    NODE = 452,                /* NODE  */
    REMOVE = 453,              /* REMOVE  */
    SNAPSHOT = 454,            /* SNAPSHOT  */
    SNAPSHOTS = 455,           /* SNAPSHOTS  */
    RECOVER = 456,             /* RECOVER  */
    RESTORE = 457,             /* RESTORE  */
    CACHES = 458,              /* CACHES  */
    CACHE = 459,               /* CACHE  */
    PERSISTENCE = 460,         /* PERSISTENCE  */
    OBJECT = 461,              /* OBJECT  */
    OBJECTS = 462,             /* OBJECTS  */
    FILES = 463,               /* FILES  */
    MEMORY = 464,              /* MEMORY  */
    ALLOCATION = 465,          /* ALLOCATION  */
    HISTORY = 466,             /* HISTORY  */
    CHECK = 467,               /* CHECK  */
    CLEAN = 468,               /* CLEAN  */
    CHECKPOINT = 469,          /* CHECKPOINT  */
    IMPORT = 470,              /* IMPORT  */
    NUMBER = 471               /* NUMBER  */
};
