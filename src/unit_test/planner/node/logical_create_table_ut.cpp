...
module infinity_core:ut.logical_create_table;
...
class LogicalCreateTableTest : public NewRequestTest {
public:
...
INSTANTIATE_TEST_SUITE_P(TestWithDifferentParams, LogicalCreateTableTest, ::testing::Values(BaseTestParamStr::NEW_CONFIG_PATH));

TEST_P(LogicalCreateTableTest, test1) {
    // Create table
    {
        ...
        for (const auto &node : nodes) {
            CheckLogicalNode(node, LogicalNodeType::kCreateTable);
        }
