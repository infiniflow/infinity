...
module infinity_core:ut.logical_create_collection;
...
class LogicalCreateCollectionTest : public NewRequestTest {
public:
...
INSTANTIATE_TEST_SUITE_P(TestWithDifferentParams, LogicalCreateCollectionTest, ::testing::Values(BaseTestParamStr::NEW_CONFIG_PATH));

TEST_P(LogicalCreateCollectionTest, test1) {
...

    {
        ...
        for (const auto &node : nodes) {
            CheckLogicalNode(node, LogicalNodeType::kCreateCollection);
        }
