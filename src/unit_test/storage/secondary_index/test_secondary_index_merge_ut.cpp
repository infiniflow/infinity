...
//         : FileWorker(std::make_shared<std::string>(InfinityContext::instance().config()->DataDir()),
//                      std::make_shared<std::string>(InfinityContext::instance().config()->TempDir()),
//                      std::make_shared<std::string>("test"),
//                      std::make_shared<std::string>("mock_highcard_path"),
//                      InfinityContext::instance().storage()->persistence_manager()),
//           index_data_(index_data), row_count_(row_count) {}
//
...
//
//     bool WriteToFileImpl(bool to_spill, bool &prepare_success, const FileWorkerSaveCtx &ctx = {}) override { return false; }
//
...
//                      std::make_shared<std::string>(InfinityContext::instance().config()->TempDir()),
//                      std::make_shared<std::string>("test"),
//                      std::make_shared<std::string>("mock_lowcard_path"),
//                      InfinityContext::instance().storage()->persistence_manager()),
//           index_data_(index_data), row_count_(row_count) {}
//
...
//     std::vector<std::pair<u32, BufferObj *>> old_chunks = {{chunk1_row_count, mock_worker1},
