...
//             index_def3 = IndexHnsw::Make(index_name3, std::make_shared<std::string>(), "idx_file3.idx", {column_def3->name()},
//             index_param_list_ptr); EXPECT_TRUE(index_def3 != nullptr); LOG_INFO("Successfully created HNSW index: " + *index_name3);
