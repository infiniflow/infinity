...
TEST_P(TestTxnReplayRestore, test_repaly_restore_table_snapshot) {
    ...
    {
        auto *txn = new_txn_mgr_->BeginTxn(std::make_unique<std::string>("create snapshot"), TransactionType::kCreateTableSnapshot);
    ...
    {
        auto *txn = new_txn_mgr_->BeginTxn(std::make_unique<std::string>("restore table"), TransactionType::kRestoreTable);
...
TEST_P(TestTxnReplayRestore, test_repaly_restore_database_snapshot) {
    ...
    {
        auto *txn = new_txn_mgr_->BeginTxn(std::make_unique<std::string>("create snapshot"), TransactionType::kCreateDBSnapshot);
    ...
    {
        auto *txn = new_txn_mgr_->BeginTxn(std::make_unique<std::string>("restore database"), TransactionType::kRestoreDatabase);
...
TEST_P(TestTxnReplayRestore, test_repaly_restore_system_snapshot) {
    ...
    {
        auto *txn = new_txn_mgr_->BeginTxn(std::make_unique<std::string>("create snapshot"), TransactionType::kCreateSystemSnapshot);
    ...
    {
        auto *txn = new_txn_mgr_->BeginTxn(std::make_unique<std::string>("restore system"), TransactionType::kRestoreSystem);
