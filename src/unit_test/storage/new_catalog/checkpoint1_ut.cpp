    ...
    {
        {
            ...
            auto *txn2 = new_txn_mgr_->BeginTxn(std::make_unique<std::string>("checkpoint"), TransactionType::kNewCheckpoint);
        ...
        RestartTxnMgr();
        {
            auto *txn = new_txn_mgr_->BeginTxn(std::make_unique<std::string>("show"), TransactionType::kRead);
