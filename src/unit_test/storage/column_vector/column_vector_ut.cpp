...
TEST_F(ColumnVectorTest, ReadWrite) {
    ...
    {
        std::shared_ptr<ColumnVector> column = ColumnVector::Make(std::make_shared<DataType>(LogicalType::kTinyInt));
        column->Initialize();
        for (size_t i = 0; i < vector_size; ++i) {
    ...
    {
        std::shared_ptr<ColumnVector> column = ColumnVector::Make(std::make_shared<DataType>(LogicalType::kSmallInt));
        column->Initialize();
        for (size_t i = 0; i < vector_size; ++i) {
    ...
    {
        std::shared_ptr<ColumnVector> column = ColumnVector::Make(std::make_shared<DataType>(LogicalType::kInteger));
        column->Initialize();
        for (size_t i = 0; i < vector_size; ++i) {
    ...
    {
        std::shared_ptr<ColumnVector> column = ColumnVector::Make(std::make_shared<DataType>(LogicalType::kBigInt));
        column->Initialize();
        for (size_t i = 0; i < vector_size; ++i) {
...
#if 0
    {
        std::shared_ptr<ColumnVector> column = ColumnVector::Make(std::make_shared<DataType>(LogicalType::kHugeInt));
        column->Initialize();
        for (size_t i = 0; i < vector_size; ++i) {
...
#endif
    {
        std::shared_ptr<ColumnVector> column = ColumnVector::Make(std::make_shared<DataType>(LogicalType::kFloat));
        column->Initialize();
        for (size_t i = 0; i < vector_size; ++i) {
    ...
    {
        std::shared_ptr<ColumnVector> column = ColumnVector::Make(std::make_shared<DataType>(LogicalType::kDouble));
        column->Initialize();
        for (size_t i = 0; i < vector_size; ++i) {
    ...
    /*
         {
            std::shared_ptr<ColumnVector> column =
                ColumnVector::Make(std::make_shared<DataType>(LogicalType::kBitmap,
       BitmapInfo::Make(1024))); column->Initialize(); for (size_t i = 0; i <
    ...
    for (size_t i = 0; i < columns.size(); i++) {
        ...
        std::shared_ptr<ColumnVector> column2 = ColumnVector::ReadAdv(ptr_r, exp_size);
