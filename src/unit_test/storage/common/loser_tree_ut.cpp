...
public:
    ...
    void GenerateData(size_t num_size, size_t loser_num, u64 max_val);
...
void LoserTreeTest::MultiWayMerge(infinity::size_t num_size, infinity::size_t loser_num, infinity::u64 max_val) {
    ...
    for (size_t i = 0; i < merge_res.size(); ++i) {
