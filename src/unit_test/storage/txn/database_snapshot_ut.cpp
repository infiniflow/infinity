...
//             auto column_def1 = std::make_shared<ColumnDef>(0, std::make_shared<DataType>(LogicalType::kInteger), "col1",
//             std::set<ConstraintType>()); auto column_def2 = std::make_shared<ColumnDef>(1, std::make_shared<DataType>(LogicalType::kVarchar),
//             "col2", std::set<ConstraintType>()); auto table_def1 = TableDef::Make(db_name, table_name1, std::make_shared<std::string>(),
//             {column_def1, column_def2}); auto table_def2 = TableDef::Make(db_name, table_name2, std::make_shared<std::string>(), {column_def1,
//             column_def2});
//
//             // Create database
//             {
