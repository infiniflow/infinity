...
// }
//
// TEST_P(TableSnapshotTest, DISABLED_MUTED_test_restore_table_create_table_multithreaded) {
...
// }
//
// TEST_P(TableSnapshotTest, DISABLED_MUTED_test_create_snapshot_same_name_multithreaded) {
...
// }
//
// TEST_P(TableSnapshotTest, DISABLED_MUTED_test_show_snapshot_multithreaded) {
...
// }
//
// TEST_P(TableSnapshotTest, DISABLED_MUTED_test_restore_table_same_snapshot_multithreaded) {
...
// }
//
// TEST_P(TableSnapshotTest, DISABLED_MUTED_test_create_snapshot_delete_data) {
//     {
//         std::string restore_sql = "restore table snapshot tb1_snapshot";
//         std::unique_ptr<QueryContext> query_context = MakeQueryContext();
//         QueryResult query_result = query_context->Query(restore_sql);
...
// }
//
// TEST_P(TableSnapshotTest, DISABLED_MUTED_test_create_snapshot_insert_data) {
//     using namespace infinity;
//     NewTxnManager *txn_mgr = infinity::InfinityContext::instance().storage()->new_txn_manager();
//
//     {
