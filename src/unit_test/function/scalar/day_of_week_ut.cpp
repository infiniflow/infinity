...
class DayOfWeekFunctionsTest : public BaseTest {};

TEST_F(DayOfWeekFunctionsTest, day_of_week_func) {
    using namespace infinity;
    ...
    RegisterDayOfWeekFunction(catalog_ptr.get());

    std::string op = "dayofweek";
