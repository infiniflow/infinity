...
module infinity_core:ut.second_function;
...
class SecondFunctionsTest : public BaseTest {};

TEST_F(SecondFunctionsTest, second_func) {
    using namespace infinity;
    ...
    RegisterSecondFunction(catalog_ptr.get());

    std::string op = "second";
