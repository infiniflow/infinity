...
module infinity_core:ut.epoch_functions;
...
class EpochFunctionsTest : public BaseTest {};

TEST_F(EpochFunctionsTest, epoch_func) {
    using namespace infinity;
    ...
    RegisterEpochFunction(catalog_ptr.get());
