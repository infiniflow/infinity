...
module infinity_core:ut.month_functions;
...
class MonthFunctionsTest : public BaseTest {};

TEST_F(MonthFunctionsTest, month_func) {
    using namespace infinity;
    ...
    RegisterMonthFunction(catalog_ptr.get());
