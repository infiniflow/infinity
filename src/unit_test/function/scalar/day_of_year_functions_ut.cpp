...
class DayOfYearFunctionsTest : public BaseTest {};

TEST_F(DayOfYearFunctionsTest, day_of_year_func) {
    using namespace infinity;
    ...
    RegisterDayOfYearFunction(catalog_ptr.get());

    std::string op = "dayofyear";
