...
module infinity_core:ut.quarter_functions;
...
class QuarterFunctionsTest : public BaseTest {};

TEST_F(QuarterFunctionsTest, quarter_func) {
    using namespace infinity;
    ...
    RegisterQuarterFunction(catalog_ptr.get());

    std::string op = "quarter";
