...
module infinity_core:ut.week_of_year_functions;
...
class WeekOfYearFunctionsTest : public BaseTest {};

TEST_F(WeekOfYearFunctionsTest, week_of_year_func) {
    using namespace infinity;
    ...
    RegisterWeekOfYearFunction(catalog_ptr.get());

    std::string op = "weekofyear";
