...
module infinity_core:ut.tiny_integer_cast;
...
TEST_F(TinyIntegerCastTest, tiny_integer_cast1) {
    ...
    // cast tiny int column vector to decimal column vector
    {
        ...
        CastParameters cast_parameters;
        EXPECT_THROW_WITHOUT_STACKTRACE(tiny2decimal_ptr.function(col_source, col_target, DEFAULT_VECTOR_SIZE, cast_parameters),
